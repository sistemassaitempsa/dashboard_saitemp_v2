  ...
  <div>
    <div class="container">
      ...
      <Tabla
        ...
        :campos="campos"
        :editar="permisos[16].autorizado"
        :eliminar="permisos[17].autorizado"
        @response="response"
        @clear="clear"
        @check="check"
      />
  ...
  methods: {
    ...
    save() {
      if (this.checks.length > 0) {
        ...
        let config = this.configHeader();
        axios.post(urlEndPoint, self.permiso, config).then(function (result) {
