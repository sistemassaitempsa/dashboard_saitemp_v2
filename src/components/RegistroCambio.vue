            ...
            <div class="modal-body" style="color: black">
              <form class="was-validated" @submit.prevent="registroCambios()">
                <div class="row">
                  <div class="col">
                    <SearchList
                      nombreCampo="¿Quien solicita la actualización?"
                      nombreItem="nombre"
                  ...
                  <div class="col">
                    <SearchList
                      nombreCampo="¿Quien autoriza la actualización:?"
                      nombreItem="nombre"
                      eventoCampo="getProfesionales"
                      :consulta="consulta_autoriza"
                      :index="2"
                      :registros="profesionales"
                      @getProfesionales="getProfesionales"
                      placeholder="Seleccione una opción"
                ...
                <div class="row">
                  <div class="col mb-3">
                    ...
                    <textarea
                      ...
                      @input="
                        observaciones = formatInputUpperCase(
                          $event.target.value
                        )
                      "
                      :maxlength="maxLength"
                    ...
                    <p
                      id="contador"
                      :class="{ 'limite-alcanzado': caracteresRestantes < 0 }"
                    >
