<template>
  <div class="container">
    ...
    <div class="row">
      <div class="col-6">
        <SearchList
          nombreCampo="Seleccione la categoria del reporte"
          eventoCampo="getSubCategoryReports"
          @getSubCategoryReports="getSubCategoryReports"
          nombreItem="nom_mod"
    ...
    <div class="row">
      <div class="col-6">
        <SearchList
          nombreCampo="Seleccione la subcategoria del reporte"
          @getSubCategoryReportsId="getSubCategoryReportsId"
          eventoCampo="getSubCategoryReportsId"
          nombreItem="des_cat"
          :registros="subcategorias"
  ...
  methods: {
    ...
    getSubCategoryReports(value = null) {
      if (value != null) {
        ...
        axios
          .get(
            self.URL_API + "api/v1/subcategoriasreporte/" + value.cod_apl,
            config
          )
          .then(function (result) {
    ...
    getReports() {
      ...
      let url = "";
      if (
        this.subcategory_reports_apl == "" &&
        this.subcategory_reports_cod == ""
      ) {
