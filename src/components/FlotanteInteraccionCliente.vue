...
export default {
  ...
  methods: {
    save() {
      ...
      axios
        .post(
          self.URL_API + "api/v1/interaccioncliente",
          this.interaccion,
          config
        )
    ...
    openModal() {
      ...
      if (
        localStorage.getItem("Fcontratacion") != null &&
        localStorage.getItem("Fcontratacion") != ""
      ) {
