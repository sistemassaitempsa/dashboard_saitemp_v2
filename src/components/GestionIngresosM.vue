    ...
    <form class="was-validated" @submit.prevent="save()">
      ...
      <div id="seccion">
        ...
        <div class="row">
          ...
          <div class="col mb-3">
            <label class="form-label">Cambio fecha: </label>
            <input
              type="date"
              class="form-control"
              autocomplete="off"
        ...
        axios
          ...
          .then(function (result) {
            if (result.data.bloqueado == "Si") {
              ...
              self.showAlertmasBoton(
                "Este candidato se encuentra en la lista trump",
                "error"
              );
            } else if (
              ...
              if (result.data.responsable_ingreso != null) {
                self.showAlertmasBoton(
                  "El número de identificación ya ha sido registrado en la fecha: \n " +
                    fechaSinHora +
                    " y actualmente tiene como responsable a " +
                    result.data.responsable_ingreso,
                  "error"
                );
              } else {
                self.showAlertmasBoton(
                  "El número de identificación ya ha sido registrado en la fecha: \n " +
                    fechaSinHora +
                    " y actualmente no cuenta con ningun responsable asignado ",
                  "error"
                );
              }
