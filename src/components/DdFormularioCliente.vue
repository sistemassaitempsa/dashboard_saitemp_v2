    ...
    <div class="row">
      ...
      <div class="col">
        ...
        <h5>
          ...
          Activos y Financiación del Terrorismo FORMATO ÚNICO DE VINCULACIÓN DE
          CONTRAPARTES
        </h5>
      </div>
      <div
    ...
    <form class="was-validated" @submit.prevent="save()">
      ...
      <div id="seccion">
        ...
        <div class="row">
          <div class="col-4">
            <SearchList
              ...
              eventoCampo="getTipoCliente"
              nombreItem="nombre"
              :consulta="consulta_tipo_cliente"
              :registros="cliente_proveedor"
              placeholder="Seleccione una opción"
            />
          </div>
          <div class="col" v-if="tipo_cliente == 2">
            <SearchList
              nombreCampo="Tipo de proveedor: *"
              @getTipoProveedor="getTipoProveedor"
              eventoCampo="getTipoProveedor"
              nombreItem="nombre"
              :consulta="consulta_tipo_proveedor"
              :registros="tipo_proveedores"
              placeholder="Seleccione una opción"
            />
          </div>
          <div class="col"></div>
        ...
        <div class="row" v-if="tipo_cliente == 1">
          <div class="col">
            <SearchList
              ...
              eventoCampo="getOperacion"
              nombreItem="nombre"
              :consulta="consulta_operacion"
          ...
          <div class="col">
            <label class="form-check-label" for="flexSwitchCheckChecked"
              >Tipo de servicio Contratacion directa:</label
            >
            <div class="col form-check" style="clear: both">
              <input
                class="form-check-input"
                type="checkbox"
                v-model="contratacion_directa"
          ...
          <div class="col">
            <label class="form-check-label" for="flexSwitchCheckChecked"
              >Tipo de servicio Atraccion y seleccion de talento:</label
            >
            <div class="col form-check" style="clear: both">
              <input
                class="form-check-input"
                type="checkbox"
                v-model="atraccion_seleccion"
                id="flexCheckIndeterminate"
              />
            </div>
          </div>
        ...
        <div class="row">
          <div class="col">
            <SearchList
              nombreCampo="Tipo de persona: *"
              @getTipoPersona="getTipoPersona"
              eventoCampo="getTipoPersona"
              nombreItem="nombre"
              :registros="tiposPersona"
              :consulta="consulta_tipo_persona"
              placeholder="Seleccione una opción"
            />
          </div>
          <div class="col">
            ...
            <input
              ...
              @input="
                (numero_identificacion = validarNumero(numero_identificacion)),
                  calcularDigitoVerificacion(numero_identificacion)
              "
              @blur="getCliente(numero_identificacion, 1)"
              :disabled="!persona_natural"
              required
            />
        ...
        <div class="row">
          ...
          <div class="col mb-3">
            ...
            <input
              ...
              @input="
                (nit = validarNumero(nit)), calcularDigitoVerificacion(nit)
              "
              @blur="getCliente(nit, 2)"
              required
            />
            <div class="invalid-feedback">
              {{ mensaje_error }}
        ...
        <div class="row">
          <div class="col mb-3">
            <label class="form-label"
              >{{ persona_natural ? "Nombre completo" : "Razón social" }}:
              *</label
            >
            <textarea
              class="form-control"
              ...
              "
              @input="razon_social = formatInputUpperCase($event.target.value)"
            ></textarea>
            <div class="invalid-feedback">
              {{ mensaje_error }}
            </div>
        ...
        <div class="row">
          ...
          <div class="col mb-3">
            <SearchList
              nombreCampo="Estrato socio económico (ubicación empresa): *"
              @getEstratos="getEstratos"
              eventoCampo="getEstratos"
              :consulta="consulta_estrato"
              nombreItem="nombre"
              :registros="estratos"
              placeholder="Seleccione una opción"
            />
        ...
        <div class="row">
          <div class="col mb-3">
            ...
            <input
              ...
              maxlength="100"
              @input="
                direccion_empresa = formatInputUpperCase($event.target.value)
              "
              aria-describedby="emailHelp"
              v-model="direccion_empresa"
              required
            />
            <div class="invalid-feedback">
              {{ mensaje_error }}
          ...
          <div class="col mb-3">
            <label class="form-label">Persona contacto empresa: * </label>
            <input
              type="text"
              class="form-control"
              id="exampleInputEmail1"
              maxlength="150"
              @input="
                contacto_empresa = formatInputUpperCase($event.target.value)
              "
              aria-describedby="emailHelp"
              v-model="contacto_empresa"
              required
            />
            <div class="invalid-feedback">
              {{ mensaje_error }}
          ...
          <div class="col mb-3">
            ...
            <input
              ...
              maxlength="200"
              @input="
                correo_electronico_empresa = formatInputUpperCase(
                  $event.target.value
                )
              "
              aria-describedby="emailHelp"
              v-model="correo_electronico_empresa"
              required
            />
            <div class="invalid-feedback">
              {{ mensaje_error }}
        ...
        <div class="row">
          ...
          <div class="col">
            <SearchList
              nombreCampo="Actividad Económica: Sociedad Comercial: *"
              nombreItem="nombre"
              :consulta="consulta_sociedad_comercial"
              :registros="sociedades_comerciales"
              eventoCampo="getSociedadesComerciales"
              @getSociedadesComerciales="getSociedadesComerciales"
              placeholder="Seleccione una opción"
            />
          </div>
        </div>
        <div class="row">
          <div class="col mb-3">
            <label class="form-label">Otra ¿Cuál?: </label>
            <input
              type="text"
              class="form-control"
              id="exampleInputEmail1"
          ...
          <div class="col">
            <SearchList
              nombreCampo="Periodicidad de pago: *"
              nombreItem="nombre"
              :consulta="consulta_periodicidad_pago"
              :registros="periodicidades_liquidacion"
              eventoCampo="getPeriodicidadPago"
              @getPeriodicidadPago="getPeriodicidadPago"
              placeholder="Seleccione una opción"
            />
          </div>
          <div class="col mb-3">
        ...
        <div class="row">
          <div class="col">
            <SearchList
              nombreCampo="Pais prestación servicio: *"
              @getPaises="getPaises"
              eventoCampo="getPaises"
              nombreItem="nombre"
              :consulta="consulta_pais_prestacion_servicio"
              :ordenCampo="2"
              :registros="paises"
              @getDepartamentos="getDepartamentos"
              placeholder="Seleccione una opción"
          ...
          <div class="col">
            <SearchList
              nombreCampo="Departamento prestación servicio: *"
              nombreItem="nombre"
              eventoCampo="getDepartamentos"
          ...
          <div class="col">
            <SearchList
              nombreCampo="Ciudad prestación servicio: *"
              nombreItem="nombre"
              :registros="municipios"
        ...
        <div class="row" v-if="tipo_cliente == 1">
          <div class="col mb-3">
            <label class="form-label">AIU negociado: * </label>
            <input
              type="text"
              class="form-control"
              id="exampleInputEmail1"
          ...
          <div class="col">
            <SearchList
              nombreCampo="Ejecutivo comercial: *"
              nombreItem="nom_ven"
              :registros="ejecutivos_comerciales"
              :consulta="consulta_ejecutivo_comercial"
        ...
        <div class="row" v-if="tipo_cliente == 1">
          <div class="col">
            <SearchList
              ...
              nombreItem="nombre"
              :registros="jornadas_laborales"
              :consulta="consulta_jornada_laboral"
              eventoCampo="getJornadasLaborales"
              @getJornadasLaborales="getJornadasLaborales"
              placeholder="Seleccione una opción"
            />
          </div>
          <div class="col">
            <SearchList
              ...
              nombreItem="nombre"
              :consulta="consulta_rotacion_personal"
              :registros="rotaciones_personal"
              eventoCampo="getRotacionesPersonal"
              @getRotacionesPersonal="getRotacionesPersonal"
              ubicacion="ciudad nacimiento"
              placeholder="Seleccione una opción"
            />
          </div>
          <div class="col">
            <SearchList
              nombreCampo="La empresa es extranjera: *"
              eventoCampo="getAfirmacionNegacion"
              nombreItem="nombre"
              :registros="afirmacionNegacion"
              :ordenCampo="5"
              :consulta="consulta_empresa_extranjera"
        ...
        <div class="row" v-if="tipo_cliente == 1">
          <div class="col-4">
            <SearchList
              ...
              :registros="afirmacionNegacion"
              :ordenCampo="6"
              :consulta="consulta_empresa_exterior"
              @getAfirmacionNegacion="getAfirmacionNegacion"
              @setAfirmacionNegacion="setAfirmacionNegacion"
              placeholder="Seleccionar"
            />
          ...
          <div class="col-4">
            <SearchList
              ...
              :registros="afirmacionNegacion"
              :ordenCampo="7"
              :consulta="consulta_vinculos_empresa"
              @getAfirmacionNegacion="getAfirmacionNegacion"
              @setAfirmacionNegacion="setAfirmacionNegacion"
              placeholder="Seleccionar"
            />
          ...
          <div class="col-4">
            <div class="col mb-3">
              <label class="form-label"
                >¿Cuántos empleados directos tiene la empresa usuaria?: *
              </label>
              <input
                type="text"
                class="form-control"
                ...
                maxlength="50"
                aria-describedby="emailHelp"
                v-model="numero_empleados_directos"
                @input="
                  numero_empleados_directos = validarNumero(
        ...
        <div class="row" v-if="tipo_cliente == 1">
          <div class="col-4">
            <SearchList
              ...
              :registros="afirmacionNegacion"
              :ordenCampo="8"
              :consulta="consulta_personal_vinculado_temporal"
              @getAfirmacionNegacion="getAfirmacionNegacion"
              @setAfirmacionNegacion="setAfirmacionNegacion"
              placeholder="Seleccionar"
            />
          ...
          <div class="col-4">
            <SearchList
              ...
              :registros="afirmacionNegacion"
              :ordenCampo="9"
              :consulta="consulta_visita_presencial"
              @getAfirmacionNegacion="getAfirmacionNegacion"
              @setAfirmacionNegacion="setAfirmacionNegacion"
              placeholder="Seleccionar"
            />
      ...
      <div id="seccion" v-if="tipo_cliente == 1">
        <div class="row">
          <div class="col mb-3">
            <label class="form-label" style="color: black"
              >Contacto notificación ingreso personal:
            </label>
            <input
              type="text"
              class="form-control"
        ...
        <div class="row">
          <div class="col mb-3">
            ...
            <input
              ...
              maxlength="20"
              aria-describedby="emailHelp"
              v-model="contratacion_telefono"
              @input="
                contratacion_telefono = validarNumero(contratacion_telefono)
              "
            />
            <div class="invalid-feedback">
              {{ mensaje_error }}
          ...
          <div class="col mb-3">
            ...
            <input
              ...
              maxlength="20"
              aria-describedby="emailHelp"
              v-model="contratacion_celular"
              @input="
                contratacion_celular = validarNumero(contratacion_celular)
              "
            />
            <div class="invalid-feedback">
              {{ mensaje_error }}
        ...
        <div class="row">
          <div class="col-6 mb-3">
            <label class="form-label" style="color: black"
              >Hora de ingreso del personal primer día:
            </label>
            <input
              type="time"
              class="form-control"
          ...
          <div class="col mb-3">
            <label class="form-label" style="color: black"
              >¿Hasta que horas se debe confirmar el ingreso del personal?
            </label>
            <input
              type="time"
              class="form-control"
              ...
              maxlength="150"
              aria-describedby="emailHelp"
              v-model="contratacion_confirma_ingreso"
            />
          </div>
        </div>
        <div class="row">
          <div class="col mb-3">
            <label class="form-label" style="color: black"
              >Correo electrónico notificación ingreso personal:
            </label>
            <input
              type="text"
              class="form-control"
              ...
              maxlength="200"
              @input="
                contratacion_correo_electronico = formatInputUpperCase(
                  $event.target.value
                )
              "
              aria-describedby="emailHelp"
              v-model="contratacion_correo_electronico"
            />
            <div class="invalid-feedback">
              {{ mensaje_error }}
            </div>
          ...
          <div class="col">
            ...
            <SearchList
              nombreCampo="Otro si solicitados: *"
              eventoCampo="getOtroSi"
              nombreItem="nombre"
              :registros="otros_si"
              :ordenCampo="8"
              :consulta="consulta_contratacion_otrosi"
              @getOtroSi="getOtroSi"
              placeholder="Seleccionar"
              :valida_campo="false"
            />
            ...
            <div class="mb-3" v-if="otros_si_agregados.length > 0">
              ...
              >
                <button
                  ...
                  v-for="(item, index) in otros_si_agregados"
                  :key="index"
                >
                  {{ item.nombre }}
                  <i
                    class="bi bi-x"
                    @click="otros_si_agregados.splice(index, 1)"
                  ></i>
                </button>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col">
            <SearchList
              nombreCampo="¿Necesita carnet de manipulación de alimentos?: *"
              eventoCampo="getAfirmacionNegacion"
              nombreItem="nombre"
              :registros="afirmacionNegacion"
              :ordenCampo="17"
              :consulta="consulta_contratacion_carnet_alimentos"
              @getAfirmacionNegacion="getAfirmacionNegacion"
              @setAfirmacionNegacion="setAfirmacionNegacion"
              placeholder="Seleccionar"
              :valida_campo="false"
          ...
          <div class="col">
            <SearchList
              ...
              :registros="afirmacionNegacion"
              :ordenCampo="22"
              :consulta="consulta_contratacion_carnet"
              @getAfirmacionNegacion="getAfirmacionNegacion"
              @setAfirmacionNegacion="setAfirmacionNegacion"
              placeholder="Seleccionar"
              :valida_campo="false"
        ...
        <div class="row">
          <div class="col">
            <SearchList
              nombreCampo="¿Se requieren tallas de uniformes?: *"
              eventoCampo="getAfirmacionNegacion"
              nombreItem="nombre"
              :registros="afirmacionNegacion"
              :ordenCampo="18"
              :consulta="consulta_contratacion_talla_uniforme"
              @getAfirmacionNegacion="getAfirmacionNegacion"
              @setAfirmacionNegacion="setAfirmacionNegacion"
              placeholder="Seleccionar"
              :valida_campo="false"
          ...
          <div class="col">
            <SearchList
              nombreCampo="¿Empresa suministra transporte?: *"
              eventoCampo="getAfirmacionNegacion"
              nombreItem="nombre"
              :registros="afirmacionNegacion"
              :ordenCampo="19"
              :consulta="consulta_contratacion_transporte"
              @getAfirmacionNegacion="getAfirmacionNegacion"
              @setAfirmacionNegacion="setAfirmacionNegacion"
              placeholder="Seleccionar"
              :valida_campo="false"
        ...
        <div class="row">
          <div class="col">
            <SearchList
              nombreCampo="¿La empresa suministra alimentación?: *"
              eventoCampo="getAfirmacionNegacion"
              nombreItem="nombre"
              :registros="afirmacionNegacion"
              :ordenCampo="20"
              :consulta="consulta_contratacion_alimentacion"
              @getAfirmacionNegacion="getAfirmacionNegacion"
              @setAfirmacionNegacion="setAfirmacionNegacion"
              placeholder="Seleccionar"
              :valida_campo="false"
          ...
          <div class="col">
            ...
            <SearchList
              nombreCampo="Seleccione el banco: *"
              eventoCampo="getConvenioBanco"
              nombreItem="nombre"
              :registros="convenio_bancos"
              :ordenCampo="8"
              :consulta="consulta_contratacion_bancos"
              @getConvenioBanco="getConvenioBanco"
              placeholder="Seleccionar"
              :valida_campo="false"
            />
          </div>
            ...
            <div class="mb-3" v-if="bancos_agregados.length > 0">
              ...
              >
                <button
                  ...
                  class="btn btn-sm"
                  data-bs-toggle="button"
                  v-for="(item, index) in bancos_agregados"
                  :key="index"
                >
                  {{ item.nombre }}
                  <i
                    class="bi bi-x"
                    @click="bancos_agregados.splice(index, 1)"
                  ></i>
                </button>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col">
            <SearchList
              nombreCampo="¿Realiza pago en efectivo?: *"
              eventoCampo="getAfirmacionNegacion"
              nombreItem="nombre"
              :registros="afirmacionNegacion"
              :ordenCampo="21"
          ...
          <div class="col">
            ...
            <SearchList
              ...
              eventoCampo="getTipoContrato"
              nombreItem="nombre"
              :registros="tipos_contrato"
              :ordenCampo="8"
              :consulta="consulta_contratacion_tipo_contrato"
            ...
            <div class="mb-3" v-if="tipos_contratos_agregados.length > 0">
              ...
              >
                <button
                  ...
                  class="btn btn-sm"
                  data-bs-toggle="button"
                  v-for="(item, index) in tipos_contratos_agregados"
                  :key="index"
                >
                  {{ item.nombre }}
                  <i
                    class="bi bi-x"
                    @click="tipos_contratos_agregados.splice(index, 1)"
                  ></i>
                </button>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col">
            <SearchList
              nombreCampo="¿La empresa paga los días 31?: *"
              eventoCampo="getAfirmacionNegacion"
              nombreItem="nombre"
              :registros="afirmacionNegacion"
              :ordenCampo="23"
              :consulta="consulta_contratacion_pago_31"
              @getAfirmacionNegacion="getAfirmacionNegacion"
              @setAfirmacionNegacion="setAfirmacionNegacion"
              placeholder="Seleccionar"
              :valida_campo="false"
          ...
          <div class="col">
            ...
            <SearchList
              nombreCampo="Pais ubicación laboratorio médico: *"
              @getPaises="getPaises"
              eventoCampo="getPaises"
              nombreItem="nombre"
              :registros="paises"
              ...
              :ordenCampo="4"
              placeholder="Seleccione una opción"
              :consulta="consulta_pais_laboratorio"
              :valida_campo="false"
            />
          </div>
        </div>
        <div class="row">
          <div class="col mb-3">
            ...
            <SearchList
              nombreCampo="Departamento ubicación laboratorio médico: *"
              nombreItem="nombre"
              eventoCampo="getDepartamentos"
              :registros="departamentos"
              @getMunicipios="getMunicipios"
              :ordenCampo="4"
              placeholder="Seleccione una opción"
              :consulta="consulta_departamento_laboratorio"
              :valida_campo="false"
            />
          </div>
          <div class="col">
            ...
            <SearchList
              nombreCampo="Ciudad ubicación laboratorio médico: *"
              nombreItem="nombre"
              :registros="municipios"
              @setMunicipios="setMunicipios"
              eventoCampo="setMunicipios"
              :ordenCampo="4"
              placeholder="Seleccione una opción"
              :consulta="consulta_municipio_laboratorio"
              :valida_campo="false"
            />
          </div>
        </div>
        <div class="row">
          <div class="col-6">
            ...
            <!-- :consulta="consulta_municipio_rl[index]" -->
            <SearchList
              nombreCampo="Laboratorio médico: *"
              nombreItem="nombre"
              :registros="laboratorios_medicos"
              @getLaboratorios="getLaboratorios"
              eventoCampo="getLaboratorios"
              placeholder="Seleccione una opción"
              :valida_campo="false"
            />
          </div>
          <div class="col mb-3">
            ...
            <textarea
              ...
              id="razon_social"
              rows="1"
              v-model="contratacion_observacion"
              placeholder=""
              @input="
                contratacion_observacion = formatInputUpperCase(
                  $event.target.value
                )
              "
            ></textarea>
            ...
            <div class="mb-3" v-if="laboratorios_medicos_agregados.length > 0">
              ...
              >
                <button
                  ...
                  class="btn btn-sm"
                  data-bs-toggle="button"
                  v-for="(item, index) in laboratorios_medicos_agregados"
                  :key="index"
                >
                  {{ item.nombre }}
                  <i
                    class="bi bi-x"
                    @click="laboratorios_medicos_agregados.splice(index, 1)"
                  ></i>
                </button>
              </div>
            </div>
      ...
      <h6 class="tituloseccion" v-if="tipo_cliente == 1">Facturación</h6>
      <div id="seccion" v-if="tipo_cliente == 1">
        <div class="row">
          <div class="col-4 mb-3">
            ...
            <input
              ...
              maxlength="50"
              aria-describedby="emailHelp"
              v-model="facturacion_contacto"
              @input="
                facturacion_contacto = formatInputUpperCase($event.target.value)
              "
              required
            />
            <div class="invalid-feedback">
          ...
          <div class="col-4 mb-3">
            ...
            <input
              ...
              maxlength="50"
              aria-describedby="emailHelp"
              v-model="facturacion_cargo"
              @input="
                facturacion_cargo = formatInputUpperCase($event.target.value)
              "
              required
            />
            <div class="invalid-feedback">
          ...
          <div class="col-4 mb-3">
            ...
            <input
              ...
              maxlength="50"
              aria-describedby="emailHelp"
              v-model="facturacion_telefono"
              @input="
                facturacion_telefono = validarNumero(facturacion_telefono)
              "
              required
            />
            <div class="invalid-feedback">
        ...
        <div class="row">
          <div class="col-4 mb-3">
            ...
            <input
              ...
              maxlength="50"
              aria-describedby="emailHelp"
              v-model="facturacion_celular"
              @input="facturacion_celular = validarNumero(facturacion_celular)"
              required
            />
            <div class="invalid-feedback">
              {{ mensaje_error }}
          ...
          <div class="col-4 mb-3">
            ...
            <input
              ...
              maxlength="50"
              aria-describedby="emailHelp"
              v-model="facturacion_correo"
              @input="
                facturacion_correo = formatInputUpperCase($event.target.value)
              "
              required
            />
            <div class="invalid-feedback">
        ...
        <div class="row">
          <div class="col-4 mb-3">
            <label class="form-label"
              >Fecha de corte para recibir las facturas: *
            </label>
            <input
              type="text"
              class="form-control"
              ...
              maxlength="50"
              aria-describedby="emailHelp"
              v-model="facturacion_fecha_corte"
              required
              @input="
                facturacion_fecha_corte = formatInputUpperCase(
                  $event.target.value
                )
              "
            />
          ...
          <div class="col-4 mb-3">
            <label class="form-label"
              >Persona encargada de recibir la factura: *
            </label>
            <input
              type="text"
              class="form-control"
              ...
              maxlength="50"
              aria-describedby="emailHelp"
              v-model="facturacion_encargado_factura"
              @input="
                facturacion_encargado_factura = formatInputUpperCase(
                  $event.target.value
                )
              "
              required
          ...
          <div class="col-4">
            <SearchList
              nombreCampo="¿Requiere anexo de la factura?: *"
              eventoCampo="getAfirmacionNegacion"
              nombreItem="nombre"
              :registros="afirmacionNegacion"
              :ordenCampo="10"
              :consulta="consulta_anexo_factura"
              @getAfirmacionNegacion="getAfirmacionNegacion"
              @setAfirmacionNegacion="setAfirmacionNegacion"
              placeholder="Seleccionar"
            />
      ...
      <h6 class="tituloseccion" v-if="tipo_cliente == 1">
        Seguridad y salud en el trabajo
      </h6>
      <div
        id="seccion"
        v-if="tipo_cliente == 1 && cargos[0].requisitos.length > 0"
      >
        <div class="row">
          <div class="row">
            <div class="col-3">
          ...
          >
            ...
            <ListaMultiple
              ...
              :verLista="verLista"
              :index="index"
              tipolista="requisitos"
              :elementoslist="requisitosList"
              :elementos="requisitos[index]"
              :hover="hover"
            />
            <ListaMultiple
              :elementoslist="examenesList"
              :verLista="verLista"
              @setLista="setLista"
              :index="index"
              tipolista="examenes"
              :elementos="examenes[index]"
              :hover="hover"
            />
            <div class="col-2">
              <SearchList
            ...
            <div class="col-1 trash">
              <i
                ...
                v-if="index > 0"
                @click="deleteDynamic(cargos, index)"
              ></i>
            </div>
          </div>
        </div>
        <span id="clasificador" @click="agregarCargo()" style="cursor: pointer"
        ...
        <div class="row cargos">
          <div class="row">
            <h5 style="text-align: left">
              Número de cargos registrados: {{ cargos2.length }}
            </h5>
            <div class="col-4">
              <SearchList
                nombreCampo="Riesgo de la empresa: (ARL):"
            ...
            <div class="col-4">
              <SearchList
                nombreCampo="¿Realizan trabajo de alto riesgo?: *"
                eventoCampo="getAfirmacionNegacion"
                nombreItem="nombre"
                :registros="afirmacionNegacion"
                :ordenCampo="11"
                :consulta="consulta_trabajo_alto_riesgo"
                @getAfirmacionNegacion="getAfirmacionNegacion"
                @setAfirmacionNegacion="setAfirmacionNegacion"
                placeholder="Seleccionar"
              />
            ...
            <div class="col-4">
              <SearchList
                nombreCampo="Accidentalidad: *"
                eventoCampo="getNivelAccidentalidad"
                nombreItem="nombre"
                :registros="nivelesAccidentalidad"
                :consulta="consulta_accidentalidad"
          ...
          <div class="row">
            <div class="col-4">
              <SearchList
                nombreCampo="Cuenta con persona encargada de SST: *"
                eventoCampo="getAfirmacionNegacion"
                nombreItem="nombre"
                :registros="afirmacionNegacion"
                :ordenCampo="12"
                :consulta="consulta_encargado_sst"
                @getAfirmacionNegacion="getAfirmacionNegacion"
                @setAfirmacionNegacion="setAfirmacionNegacion"
                placeholder="Seleccionar"
              />
            ...
            <div class="col-4 mb-3" v-if="encargado_sst_id == 1">
              <label class="form-label">Nombre encargado SST: * </label>
              <input
                type="text"
                class="form-control"
                id="exampleInputEmail1"
                maxlength="50"
                aria-describedby="emailHelp"
                v-model="nombre_encargado_sst"
                @input="
                  nombre_encargado_sst = formatInputUpperCase(
                    $event.target.value
                  )
                "
                required
            ...
            <div class="col-4 mb-3" v-if="encargado_sst_id == 1">
              <label class="form-label">Cargo analista SST: * </label>
              <input
                type="text"
                class="form-control"
                id="exampleInputEmail1"
                maxlength="50"
                aria-describedby="emailHelp"
                v-model="cargo_encargado_sst"
                @input="
                  cargo_encargado_sst = formatInputUpperCase(
                    $event.target.value
                  )
                "
                required
          ...
          <div class="row">
            <div class="col-4">
              <SearchList
                nombreCampo="¿Realizan inducción y entrenamiento?: *"
                eventoCampo="getAfirmacionNegacion"
                nombreItem="nombre"
                :registros="afirmacionNegacion"
                :ordenCampo="13"
                :consulta="consulta_induccion_entrenamiento"
                @getAfirmacionNegacion="getAfirmacionNegacion"
                @setAfirmacionNegacion="setAfirmacionNegacion"
                placeholder="Seleccionar"
              />
            ...
            <div class="col-4">
              <SearchList
                nombreCampo="¿Entregan dotación?: *"
                eventoCampo="getAfirmacionNegacion"
                nombreItem="nombre"
                :registros="afirmacionNegacion"
                :ordenCampo="14"
                :consulta="consulta_entrega_dotacion"
                @getAfirmacionNegacion="getAfirmacionNegacion"
                @setAfirmacionNegacion="setAfirmacionNegacion"
                placeholder="Seleccionar"
              />
            ...
            <div class="col-4">
              <SearchList
                nombreCampo="¿Fue evaluado el SGST por la ARL?: *"
                eventoCampo="getAfirmacionNegacion"
                nombreItem="nombre"
                :registros="afirmacionNegacion"
                :ordenCampo="15"
                :consulta="consulta_evaluado_arl"
                @getAfirmacionNegacion="getAfirmacionNegacion"
                @setAfirmacionNegacion="setAfirmacionNegacion"
                placeholder="Seleccionar"
              />
          ...
          <div class="row">
            <div class="col-4">
              <SearchList
                nombreCampo="¿Entrega EPP?: *"
                eventoCampo="getAfirmacionNegacion"
                nombreItem="nombre"
                :registros="afirmacionNegacion"
                :ordenCampo="16"
                :consulta="consulta_entrega_epp"
                @getAfirmacionNegacion="getAfirmacionNegacion"
                @setAfirmacionNegacion="setAfirmacionNegacion"
                placeholder="Seleccionar"
              />
          ...
          <div class="row" v-if="entrega_epp_id == 1">
            <div v-for="(item, index) in elementospp" :key="index">
              <div class="row" v-if="item.descripcion == '0'">
                <h5
                  style="
                    background-color: rgba(192, 190, 190, 0.767);
                    text-align: left;
                    padding: 15px;
                  "
                >
              ...
              <div class="col">
                <div class="col-12 lista-multiple">
                  <button
                    ...
                    v-for="(item, index) in array_lista_examenes[index]"
                    :key="index"
                    type="button"
                  >
                    {{ item.nombre }}
          ...
          <div class="col">
            <div class="input-group">
              <input
                ...
                :accept="fileInputsCount[index].tipo_archivo"
      ...
      <div id="seccion">
        <div class="row">
          ...
          <p style="text-align: justify">
            Socios o Accionistas Diligencie la información de los accionistas,
            socios o asociados con una participación igual o superior al 5%. En
            el evento en que los accionistas, socios o asociados sean personas
            jurídicas, anexar la composición patrimonial de dichas personas
            jurídicas. Anexar listado en caso de ser necesario.
          </p>
        </div>
        <div
          class="accionista"
          v-for="(item, index) in accionistas"
          :key="index"
        >
          <div class="row">
            <div class="col">
            ...
            <div class="col">
              <label for="exampleInputEmail1" class="form-label"
                >Porcentaje Participación (%):</label
              >
              <input
                type="text"
                class="form-control"
            ...
            <div class="col-1 trash">
              <i
                class="bi bi-trash-fill"
                v-if="index > 0"
                @click="deleteDynamic(accionistas, index)"
              ></i>
            </div>
          </div>
        </div>
      ...
      <div id="seccion">
        <div
          class="representante"
          v-for="(item, index) in representantes_legales"
          :key="index"
        >
          <div class="row">
            <div class="col mb-3">
            ...
            <div class="col-1 trash">
              <i
                class="bi bi-trash-fill"
                v-if="index > 0"
                @click="deleteDynamic(representantes_legales, index)"
              ></i>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col">
              <SearchList
                nombreCampo="Pais de expedición: *"
                @getPaises="getPaises"
                eventoCampo="getPaises"
                nombreItem="nombre"
                :registros="paises"
            ...
            <div class="col mb-3">
              <SearchList
                nombreCampo="Departamento de expedición: *"
                nombreItem="nombre"
                eventoCampo="getDepartamentos"
                :registros="departamentos"
                @getMunicipios="getMunicipios"
            ...
            <div class="col">
              <SearchList
                nombreCampo="Ciudad de expedición: *"
                nombreItem="nombre"
                :registros="municipios"
                @setMunicipios="setMunicipios"
                eventoCampo="setMunicipios"
        ...
        <span
          id="clasificador"
          @click="agregarRepresentanteLegal()"
      ...
      <div id="seccion">
        <div class="row">
          <div class="col">
            <label class="form-check-label" for="flexSwitchCheckChecked"
              >La empresa cuenta con Junta directiva:</label
            >
          </div>
          <div style="display: flex">
          ...
          <div class="row" v-for="(item, index) in miembros_Junta" :key="index">
            ...
            <div class="col-1 trash">
              <i
                class="bi bi-trash-fill"
                v-if="index > 0"
                @click="deleteDynamic(miembros_Junta, index)"
              ></i>
            </div>
          </div>
          <span
            id="clasificador"
            @click="agregarMiembrosJunta()"
            style="cursor: pointer"
            ><i class="bi bi-plus-circle-fill"></i>
      ...
      <div id="seccion">
        <div class="row">
          <div class="col">
            <SearchList
              nombreCampo="Responsable de Impuestos a las Ventas: *"
              nombreItem="nombre"
              @getAfirmacionNegacion="getAfirmacionNegacion"
              eventoCampo="getAfirmacionNegacion"
              :registros="afirmacionNegacion"
              @setAfirmacionNegacion="setAfirmacionNegacion"
              :ordenCampo="1"
              :consulta="consulta_responsable_impuesto_ventas"
              placeholder="Seleccione una opción"
            />
          </div>
          <div class="col">
            <label for="exampleInputEmail1" class="form-label"
              >Correo para factura electrónica: *</label
            >
            <input
              type="text"
              class="form-control"
              ...
              maxlength="200"
              @input="
                correo_factura_electronica = formatInputUpperCase(
                  $event.target.value
                )
              "
              aria-describedby="emailHelp"
              v-model="correo_factura_electronica"
              required
            />
            <div class="invalid-feedback">
              {{ mensaje_error }}
          ...
          <div class="col">
            <SearchList
              nombreCampo="Sucursal para facturación: *"
              eventoCampo="getSucursales"
              @getSucursales="getSucursales"
              nombreItem="nom_suc"
              :registros="sucursales"
              placeholder="Seleccione una opción"
              :consulta="consulta_sucursal_facturacion"
            />
          </div>
        </div>
        <div
          class="row"
          v-for="(item, index) in calidad_tributaria"
          :key="index"
        >
          <div class="col">
            <SearchList
              :nombreCampo="item.nombre"
              @getAfirmacionNegacion="getAfirmacionNegacion"
              eventoCampo="getAfirmacionNegacion"
              nombreItem="nombre"
              @setAfirmacionNegacion="setAfirmacionNegacion"
          ...
          <div class="col">
            ...
            <span
              ...
              v-if="
                ...
                calidad_tributaria[index].opcion == 1
              "
              class="error"
              >{{ mensaje_error }}</span
            >
          ...
          <div class="col">
            ...
            <span
              id="validate"
              v-if="item.fecha == '' && calidad_tributaria[index].opcion == 1"
              class="error"
              >{{ mensaje_error }}</span
            >
          </div>
        ...
        <div class="row">
          <div class="col mb-3">
            ...
            <input
              ...
              maxlength="100"
              @input="
                nombre_completo_contador = formatInputUpperCase(
                  $event.target.value
                )
              "
              aria-describedby="emailHelp"
              v-model="nombre_completo_contador"
              :required="
                nombre_completo_contador == '' &&
                tipo_identificacion_contador != '' &&
                tipo_identificacion_contador.trim() != '0'
              "
            />
            <span
              id="validate"
          ...
          <div class="col mb-3">
            ...
            <input
              ...
              maxlength="20"
              aria-describedby="emailHelp"
              v-model="identificacion_contador"
              @input="
                identificacion_contador = validarNumero(identificacion_contador)
              "
              :required="
        ...
        <div class="row">
          <div class="col mb-3">
            ...
            <input
              ...
              maxlength="100"
              @input="
                nombre_completo_tesorero = formatInputUpperCase(
                  $event.target.value
                )
              "
              aria-describedby="emailHelp"
              v-model="nombre_completo_tesorero"
            />
          </div>
          <div class="col mb-3">
            <label for="exampleInputEmail1" class="form-label">Teléfono:</label>
      ...
      <div id="seccion">
        <div class="row">
          ...
          <div class="col mb-3">
            ...
            <input
              ...
              aria-describedby="emailHelp"
              v-model="activos"
              @input="activos = validarNumero(activos)"
              required
            />
            <div class="invalid-feedback">
              {{ mensaje_error }}
        ...
        <div class="row">
          ...
          <div class="col mb-3">
            <label for="exampleInputEmail1" class="form-label"
              >Detalle de otros ingresos: *</label
            >
            <input
              type="text"
              class="form-control"
          ...
          <div class="col mb-3">
            ...
            <input
              ...
              aria-describedby="emailHelp"
              v-model="pasivos"
              @input="pasivos = validarNumero(pasivos)"
              required
            />
            <div class="invalid-feedback">
              {{ mensaje_error }}
        ...
        <div class="row">
          ...
          <div class="col mb-3">
            <label for="exampleInputEmail1" class="form-label"
              >Reintegro de costos y gastos: *</label
            >
            <input
              type="text"
              class="form-control"
      ...
      <div id="seccion">
        <div class="row">
          <div class="col">
            <SearchList
              nombreCampo="Realiza operaciones en moneda extranjera: *"
              nombreItem="nombre"
              @getAfirmacionNegacion="getAfirmacionNegacion"
              eventoCampo="getAfirmacionNegacion"
              :consulta="consulta_operacion_moneda_extranjera"
              :registros="afirmacionNegacion"
              @setAfirmacionNegacion="setAfirmacionNegacion"
              :orden-campo="3"
              placeholder="Seleccionar"
            ...
            <span
              id="validate"
              v-if="operaciones_modena_extranjera == ''"
              class="error"
              >{{ mensaje_error }}</span
            >
          </div>
          <div class="col">
            <SearchList
              nombreCampo="¿Que operaciones?: *"
              @getTiposOperacionesInternacionales="
                getTiposOperacionesInternacionales
              "
              eventoCampo="getTiposOperacionesInternacionales"
              nombreItem="nombre"
              :consulta="consulta_operacion_internacional"
              :registros="tipos_operaciones_internacionales"
              placeholder="Seleccione una opción"
            />
          </div>
        </div>
      ...
      <div id="seccion">
        <div v-for="(item, index) in referencias_bancarias" :key="index">
          <div class="row">
            ...
            <div class="col">
              <SearchList
                nombreCampo="Tipo cuenta"
                @getTipoCuentaBancos="getTipoCuentaBancos"
                @setTipoCuentaBancos="setTipoCuentaBancos"
                eventoCampo="getTipoCuentaBancos"
                :ordenCampo="1"
                :index="index"
                nombreItem="nombre"
                :registros="tipos_cuenta_bancos"
                placeholder="Seleccione una opción"
                :consulta="consulta_tipo_cuenta_banco_rb[index]"
              />
            </div>
            <div class="col-1 trash">
              <i
                class="bi bi-trash-fill"
                v-if="index > 0"
                @click="deleteDynamic(referencias_bancarias, index)"
              ></i>
            </div>
          </div>
          <div class="row">
            <div class="col mb-3">
              ...
              <input
                ...
                maxlength="100"
                @input="
                  item.sucursal = formatInputUpperCase($event.target.value)
                "
                aria-describedby="emailHelp"
            ...
            <div class="col mb-3">
              ...
              <input
                ...
                maxlength="100"
                @input="
                  item.contacto = formatInputUpperCase($event.target.value)
                "
                aria-describedby="emailHelp"
        ...
        <span
          id="clasificador"
          @click="agregarReferenciasBancarias()"
          style="cursor: pointer"
          ><i class="bi bi-plus-circle-fill"></i>
      ...
      <div id="seccion">
          ...
          <div class="row">
            ...
            <div class="col-1 trash">
              <i
                class="bi bi-trash-fill"
                v-if="index > 0"
                @click="deleteDynamic(referencias_comerciales, index)"
              ></i>
            </div>
          </div>
        </div>
        <span
          id="clasificador"
          @click="agregarReferenciasComerciales()"
          style="cursor: pointer"
          ><i class="bi bi-plus-circle-fill"></i>
      ...
      <div id="seccion">
        <div class="row">
          <p>
            Cumplo con alguno de los siguientes atributos o tengo un vínculo
            familiar (cónyuge o compañero permanente, padres, abuelos, hijos,
            nietos, cuñados, adoptantes o adoptivos) con una persona que:
          </p>
          <ul>
            <li>
            ...
            <li>
              <p>
                En afirmativo indique que le aplica y diligencie la siguiente
                información
              </p>
            </li>
          </ul>
      ...
      <h6 class="tituloseccion">
        2.1 Datos de personas expuestas politicamente
      </h6>
      <div id="seccion">
        <div
          class="row"
          v-for="(item, index) in personas_expuestas"
          :key="item.id"
        >
          <div class="col">
            <label for="exampleInputEmail1" class="form-label"
              >Nombres y apelldos:</label
            >
            <input
              type="text"
              class="form-control"
          ...
          <div class="col">
            <SearchList
              ...
              :registros="tiposIdentificacion"
              placeholder="Seleccione una opción"
              :consulta="consultas_personas_expuestas[index]"
            />
          </div>
          <div class="col">
            <label for="exampleInputEmail1" class="form-label"
          ...
          <div class="col">
            ...
            <input
              ...
              maxlength="50"
              @input="
                item.parentesco = formatInputUpperCase($event.target.value)
              "
              aria-describedby="emailHelp"
          ...
          <div class="col-1 trash">
            <i
              class="bi bi-trash-fill"
              v-if="index > 0"
              @click="deleteDynamic(personas_expuestas, index)"
            ></i>
          </div>
        </div>
        <span
          id="clasificador"
          @click="agregarPersonasExpuestas()"
          style="cursor: pointer"
          ><i class="bi bi-plus-circle-fill"></i>
      ...
      <div id="seccion">
        <div class="row">
          <p>
            Quien suscribe la presente solicitud obrando en nombre propio y/o en
            representación legal de la persona jurídica que represento, de
            manera voluntaria y dando certeza de que todo lo aquí consignado es
            cierto, veraz y verificable, realizo la siguiente declaración de
            fuente de bienes y/o fondos, con el propósito de dar cumplimiento a
            lo señalado al respecto a las normas legales vigentes y
            concordantes.
          </p>
          <ul>
            <li>
              <p>
                A. Declaro que yo y/o la persona jurídica que represento es
                beneficiaria efectiva de los recursos y son compatibles con mis
                actividades y situación patrimonial.
              </p>
            </li>
            <li>
              <p>
                B. Que los recursos que se entreguen de mi parte en desarrollo
                de cualquiera de las relaciones contractuales que tenga con los
                destinatarios de la presente declaración, provienen de mi
                patrimonio y/o de la sociedad que represento y no de terceros, y
                se derivan de las siguientes fuentes: (detalle de la actividad o
                negocio del que provienen los recursos)
              </p>
            </li>
          </ul>
          <div class="col">
            <SearchList
              nombreCampo="Seleccione una opción"
              @getTipoOrigenFondos="getTipoOrigenFondos"
              eventoCampo="getTipoOrigenFondos"
              nombreItem="nombre"
              :registros="tipos_origen_fondos"
              placeholder="Origen de fondos"
              :consulta="consulta_origen_fondos"
            />
          </div>
          <div class="col mb-3">
            <label for="exampleInputEmail1" class="form-label"
            ...
            <input
              ...
              maxlength="100"
              @input="
                otro_tipo_origen_fondos = formatInputUpperCase(
                  $event.target.value
                )
              "
              aria-describedby="emailHelp"
          ...
          <ul>
            <li>
              <p>
                C. Declaro que los recursos no provienen de ninguna actividad
                ilícita de las contempladas en el Código Penal Colombiano o en
                cualquier norma que lo modifique o adicione.
              </p>
            </li>
            <li>
              <p>
                D. No se admitirá que terceros efectúen depósitos a mis cuentas
                y/o de la Entidad que represento con fondos provenientes de las
                actividades ilícitas contempladas en el Código penal Colombiano
                o en cualquier norma que lo modifique, sustituya o adicione, ni
                se efectuarán transacciones destinadas a tales actividades o a
                favor de personas relacionadas con las mismas
              </p>
            </li>
            <li>
              <p>
                E. Los recursos que recibo de mis contrapartes principalmente
                los capto por (seleccione máximo 2)
              </p>
            </li>
          </ul>
          <div class="col">
            <SearchList
              @getTipoOrigenMedios="getTipoOrigenMedios"
              eventoCampo="getTipoOrigenMedios"
              @setTipoOrigenMedios="setTipoOrigenMedios"
              nombreItem="nombre"
              :ordenCampo="1"
              :registros="tipos_origenes_medios"
              placeholder="seleccione una opción"
          ...
          <ul>
            <li>
              <p>
                F. Las operaciones que realizo por mi actividad implican un alto
                manejo de efectivo
              </p>
            </li>
          </ul>
          <div class="col">
            <SearchList
              ...
              :ordenCampo="4"
              placeholder="Seleccione una opción"
              :consulta="consulta_origen_manejo_efectivo"
            />
          </div>
          <p>
            En nombre propio y/o de mi representado, declaro que no estoy
            impedido para realizar cualquier tipo de operación y que conozco y
            acepto las normas que regulan el comercio colombiano y me obligo a
            cumplirlas. Conozco y acepto los riesgos que puedan presentarse
            frente a las instrucciones y órdenes que imparta, derivados de la
            utilización de los medios y canales de distribución de productos y
            servicios, tales como Internet, correos electrónicos u otros
            mecanismos similares, mensajería instantánea, teléfono, fax, medios
            digitales entre otros. Autorizo a realizar los traslados de recursos
            y/o valores, previo cumplimiento de los procedimientos establecidos
            por la entidad; así mismo, autorizo la realización de transferencias
            bancarias y conozco los riesgos de su utilización. Conozco y acepto
            las políticas establecidas para todos los productos ofrecidos,
            incluyendo los servicios de Internet. Bajo la gravedad de juramento
            manifiesto que todos los datos acá consignados, incluidos los
            números de identificación tributaria, son ciertos, que la
            información que adjunto es veraz, fidedigna, completa y verificable
            y autorizo su verificación ante cualquier persona natural o
            jurídica, pública o privada, sin limitación alguna, desde ahora y
            mientras subsista alguna relación comercial y que toda declaración
            falsa o inexacta podrá ser sancionada, por las autoridades de
            conformidad con la legislación aplicable. Me comprometo a actualizar
            la información y documentación de acuerdo con la solicitud que se me
            haga, a proporcionar toda la información adicional y de apoyo que
            sea necesaria y requerida, por lo menos cada año y cada vez que se
            presenten modificaciones respecto de cualquiera de mis datos, esto
            con el fin de dar cumplimiento a la normatividad vigente para el
            efecto, y por tanto, autorizo, entre otras, a reportar la
            información fiscal, a verificar la autenticidad de mis firmas y de
            mis ordenantes y/o a validar los poderes y facultades de mis
            representantes. A su vez declaro que asumiré la responsabilidad
            civil, administrativa y/o penal derivada de cualquier información
            errónea, falsa o inexacta que llegaré a suministrar o que dejare de
            suministrar oportunamente. De igual forma, declaro que resarciré a
            La empresa por cualquier multa, perdida o daño que pudiera llegar a
            sufrir como consecuencia de la inexactitud o falsedad de dicha
            información Autorizo a La empresa a suministrar la información
            contenida ente documento, al igual que sus anexos, a las autoridades
            administrativas y gubernamentales correspondientes, incluidas las
            autoridades de mi país de residencia o de nacionalidad, de
            conformidad con la regulación vigente, entre ellos, los Convenios
            Internacionales firmados por Colombia. Manifiesto que yo y/o la
            empresa que represento y sus empleados conocen bien las normas
            referentes a la prevención del Lavado de Activos y Financiación del
            Terrorismo, todos aportamos con el fin de no ser cómplices de la
            violación de las normas de esta ley. Igualmente, que no he
            pertenecido ni pertenezco a ningún tipo de grupos ilegales al margen
            de la Ley, no les he auxiliado o colaborado en el desarrollo de sus
            actividades ilícitas, como tampoco he realizado actividades de
            lavados de activos en Colombia o fuera de ella y que los bienes que
            conforman mi patrimonio han sido adquiridos por vías legales en
            desarrollo de mi profesión o actividad. De la misma manera, declaro
            que no tengo vínculos de parentesco con personas que estén o hayan
            estado incluidas en listas públicas como sospechosos de Lavado de
            Activos/Financiación de terrorismo o las empresas de las cuales sean
            accionistas, o que desarrollen o hayan desarrollado, apoyado o
            financiado cualquiera de las actividades descritas en el párrafo
            precedente. Todos los datos aquí consignados y los documentos anexos
            a él, son ciertos, la información que adjunto es veraz y
            verificable, y autorizo su verificación ante cualquier persona
            natural o jurídica, privada o pública, sin limitación alguna, desde
            ahora y mientras subsista alguna relación comercial con cualquiera
            de las entidades que pertenezcan a SAITEMP S.A. o con quien
            represente sus derechos, y me comprometo a actualizar la información
            y/o documentación al menos una vez cada 2 años o cada vez que se me
            indique. Así mismo, autorizo a SAITEMP S.A., o a quien represente
            sus derechos, en forma permanente e irrevocable, para que con fines
            estadísticos y de información financiera o comercial, consulte,
            informe, reporte, procese o divulgue, a las entidades de consulta de
            bases de datos o Centrales de Información y Riesgo, todo lo
            referente a mi comportamiento como cliente en general.
          </p>
        </div>
      </div>
      <h6 class="tituloseccion">
        2.4. Autorización de Tratamiento de Datos Personales
      </h6>
      <div id="seccion">
        <div class="row">
          <p>
            La Sociedad SAITEMP S.A., en cumplimiento de lo definido por la Ley
            1581 de 2012, el decreto reglamentario 1377 de 2013 y nuestra
            política de protección de datos personales, le informan que los
            datos personales que usted suministre en cualquiera de nuestros
            establecimientos en desarrollo de cualquier operación comercial,
            serán tratados mediante el uso y mantenimiento de medidas de
            seguridad técnicas, físicas y administrativas a fin de impedir que
            terceros no autorizados accedan a los mismos, lo anterior de
          ...
          <div style="display: flex">
            <div class="form-check m-2">
              <input
                class="form-check-input"
                type="radio"
                v-model="tratamiento_datos_personales"
                :value="true"
                name="radio5"
                id="radio5"
              />
      ...
      <div class="col-3" v-if="hide_bottons">
        <SearchList
          ...
          :valida_campo="false"
          nombreItem="nombre"
          :registros="razon_social_cliente"
          consulta=""
          eventoCampo="setFormularioGuardado"
          @setFormularioGuardado="setFormularioGuardado"
          placeholder="Seleccionar"
        />
      </div>
      <div class="row">
          ...
          >
            ...
            <div class="btn-group" role="group">
              ...
              <ul class="dropdown-menu">
                <li v-for="(item, index) in razon_social_cliente" :key="index">
                  <a
                    class="dropdown-item"
                    style="cursor: pointer"
...
export default {
  ...
  data() {
    return {
      ...
      miembros_Junta: [
        { nombre: "", tipo_identificacion_id: "", identificacion: "" },
      ],
      ...
      calidad_tributaria: [
        {
          nombre: "¿Es Gran Contribuyente?:",
          opcion: "",
          numero_resolucion: "",
          fecha: "",
        },
        {
          nombre: "¿Es Auto-Retenedor?",
          opcion: "",
          numero_resolucion: "",
          fecha: "",
        },
        {
          nombre: "¿Exento de Impuesto a la Renta?",
          opcion: "",
          numero_resolucion: "",
          fecha: "",
        },
  ...
  created() {
    ...
    if (
      ...
      self.formularios_guardados.forEach(function (item, index) {
        self.razon_social_cliente.push({
          codigo: index,
  ...
  methods: {
    ...
    eliminarItem(registro) {
      ...
      if (
        ...
        self.formularios_guardados = JSON.parse(
          localStorage.getItem("cliente")
        );
        self.formularios_guardados.forEach(function (item, index) {
          if (item.razon_social == registro.nombre) {
            ...
            localStorage.setItem(
              "cliente",
              JSON.stringify(self.formularios_guardados)
            );
          }
        });
      }
    ...
    guardadoParcial() {
      ...
      if (this.razon_social == "") {
        this.showAlert(
          "Debe diligenciar el campo razón social para guardar el formulario de forma parcial",
          "error"
        );
        return;
      } else {
        this.showAlert(
          "Se realizó un guardado de forma parcial exitosamente",
          "success"
        );
      }
      this.crearCliente();
    ...
    agregarCamposCliente() {
      ...
      self.registroCliente.consulta_tipo_identificacion =
      ...
      self.registroCliente.correo_electronico_empresa =
      ...
      self.registroCliente.consulta_sociedad_comercial =
        this.consulta_sociedad_comercial;
      self.registroCliente.otra_cual = this.otra_cual;
      self.registroCliente.consulta_periodicidad_pago =
        this.consulta_periodicidad_pago;
      self.registroCliente.plazo_pago = this.plazo_pago;
      self.registroCliente.consulta_pais_prestacion_servicio =
        this.consulta_pais_prestacion_servicio;
      self.registroCliente.consulta_departamento_prestacion_servicio =
        this.consulta_departamento_prestacion_servicio;
      self.registroCliente.consulta_municipio_prestacion_servicio =
      ...
      self.registroCliente.consulta_operacion_moneda_extranjera =
        this.consulta_operacion_moneda_extranjera;
      self.registroCliente.consulta_operacion_internacional =
        this.consulta_operacion_internacional;
      self.registroCliente.declaraciones_autorizaciones =
        this.declaraciones_autorizaciones;
      self.registroCliente.consulta_origen_fondos = this.consulta_origen_fondos;
      self.registroCliente.otro_tipo_origen_fondos =
        this.otro_tipo_origen_fondos;
      self.registroCliente.consulta_origen_medios1 =
        this.consulta_origen_medios1;
      self.registroCliente.consulta_origen_medios2 =
        this.consulta_origen_medios2;
      self.registroCliente.consulta_origen_manejo_efectivo =
        this.consulta_origen_manejo_efectivo;
      self.registroCliente.tratamiento_datos_personales =
        this.tratamiento_datos_personales;
      self.registroCliente.codigo_ciiu_id = this.codigo_ciiu_id;
      self.registroCliente.consulta_tipo_identificacion_ac =
        this.consulta_tipo_identificacion_ac;
      self.registroCliente.consulta_tipo_identificacion_rl =
        this.consulta_tipo_identificacion_rl;
      self.registroCliente.consulta_tipo_identificacion_miembros_junta =
        this.consulta_tipo_identificacion_miembros_junta;
      self.registroCliente.consultas_personas_expuestas =
        this.consultas_personas_expuestas;
      self.registroCliente.consulta_banco_rb = this.consulta_banco_rb;
      self.registroCliente.consulta_tipo_cuenta_banco_rb =
      ...
      self.registroCliente.consulta_departamento_rl =
        this.consulta_departamento_rl;
      self.registroCliente.consulta_municipio_rl = this.consulta_municipio_rl;

      self.registroCliente.consulta_empresa_extranjera =
        this.consulta_empresa_extranjera;
      self.registroCliente.consulta_empresa_exterior =
        this.consulta_empresa_exterior;
      self.registroCliente.consulta_vinculos_empresa =
        this.consulta_vinculos_empresa;
      self.registroCliente.numero_empleados_directos =
        this.numero_empleados_directos;
      self.registroCliente.consulta_personal_vinculado_temporal =
        this.consulta_personal_vinculado_temporal;
      self.registroCliente.consulta_visita_presencial =
        this.consulta_visita_presencial;
      ...
      self.registroCliente.facturacion_fecha_corte =
        this.facturacion_fecha_corte;
      self.registroCliente.facturacion_encargado_factura =
        this.facturacion_encargado_factura;
      self.registroCliente.consulta_anexo_factura = this.consulta_anexo_factura;
      self.registroCliente.consulta_trabajo_alto_riesgo =
        this.consulta_trabajo_alto_riesgo;
      self.registroCliente.consulta_accidentalidad =
        this.consulta_accidentalidad;
      ...
      self.registroCliente.consulta_induccion_entrenamiento =
        this.consulta_induccion_entrenamiento;
      self.registroCliente.consulta_entrega_dotacion =
        this.consulta_entrega_dotacion;
      ...
      this.cargos2.forEach(function (item, index) {
        item.tipo_cargo =
          self.tipo_cargo[index] == 1 ? "Administrativo" : "Operativo";
    ...
    getListaExamenes(index = null) {
      if (index != null) {
        ...
        axios
          .get(
            self.URL_API + "api/v1/listaexamenes/" + this.categoria_cargo_id,
            config
          )
          .then(function (result) {
    ...
    getCliente(id, tipo_id) {
      if (id != null && id.trim() != "") {
        ...
        return axios
          .get(
            self.URL_API + "api/v1/clienteexist/" + id + "/" + tipo_id,
            config
          )
          .then(function (result) {
            if (
    ...
    guardarArchivos(id) {
      ...
      this.file.forEach(function (item, index) {
        if (item.size > self.limite) {
          self.showAlert(
            "El archivo" +
              item.name +
              "es demasiado pesado, el limite es de 3MB",
            "error"
          );
          bandera++;
        }
      ...
      if (bandera <= 0) {
        axios
          .post(
            self.URL_API + "api/v1/formulariocliente/doc/" + id,
            document,
            config
          )
          .then(function (result) {
    ...
    agregarRepresentanteLegal() {
      if (this.representantes_legales.length <= 4) {
        this.representantes_legales.push({
          nombre: "",
          tipo_identificacion: "",
          identificacion: "",
          municipio: "",
    ...
    agregarReferenciasBancarias() {
      if (this.referencias_bancarias.length <= 1) {
        this.referencias_bancarias.push({
          banco_id: "",
          numero_cuenta: "",
          tipo_cuenta: "",
          sucursal: "",
    ...
    agregarReferenciasComerciales() {
      if (this.referencias_comerciales.length <= 1) {
        this.referencias_comerciales.push({
          nombre: "",
          contacto: "",
          telefono: "",
        });
    ...
    getOtroSi(item = null) {
      ...
      let self = this;
      let config = this.configHeader();
      axios.get(self.URL_API + "api/v1/otrosi", config).then(function (result) {
    ...
    getTipoContrato(item = null) {
      ...
      let self = this;
      axios
        .get(self.URL_API + "api/v1/tipocontrato", config)
        .then(function (result) {
      ...
      if (item != null) {
        switch (campo) {
          ...
          case 5:
            ...
            break;
          case 6:
            this.personas_expuestas[index].tipo_identificacion_id =
              item.cod_tip;
    ...
    getLaboratorios(item = null) {
      if (item != null) {
        var nombreExistente = this.laboratorios_medicos_agregados.some(
          function (objeto) {
            return objeto.nombre === item.nombre;
          }
        );
        if (!nombreExistente) {
          this.laboratorios_medicos_agregados.push({
            id_ciudad: item.ciudad_id,
            id: item.id,
            nombre: item.nombre,
          });
        }
      ...
      axios
        .get(
          self.URL_API + "api/v1/laboratorios/" + this.municipio_laboratorio_id,
          config
        )
        .then(function (result) {
    ...
    filterResults(value, array, nombrearray) {
      const search = array.filter((item) =>
        item.nombre.toLowerCase().match(value.toLowerCase())
      );
    ...
    limpiarformulario() {
      ...
      this.referencias_comerciales = [
        { nombre: "", contacto: "", telefono: "" },
      ];
      this.declaraciones_autorizaciones = false;
      this.personas_expuestas = [
        {
          nombre: "",
          tipo_identificacion_id: "",
          identificacion: "",
    ...
    valida_campos() {
      ...
      if (this.tipo_cliente == 2 && this.tipo_proveedor == "") {
        this.showAlert(
          "Error, debe diligenciar el tipo de proveedor.",
          "error"
        );
        return true;
      }
      if (this.tipo_cliente == 1 && this.operacion == "") {
        this.showAlert(
          "Error, debe diligenciar el tipo de operación.",
          "error"
        );
        return true;
      }
      ...
      if (this.tipo_identificacion == "" && this.tipo_persona == 1) {
        this.showAlert(
          "Error, debe diligenciar el tipo de identificacion.",
          "error"
        );
        return true;
      }
      ...
      if (this.numero_identificacion == "" && this.tipo_persona == 1) {
        this.showAlert(
          "Error, debe diligenciar el numero de identificacion.",
          "error"
        );
        return true;
      }
      if (this.fecha_expedicion == "" && this.tipo_persona == 1) {
        this.showAlert(
          "Error, debe diligenciar la fecha de expedicion.",
          "error"
        );
        return true;
      }
      ...
      if (
        ...
        this.showAlert(
          "Error, debe seleccionar al menos un tipo de servicio y los campos obligatorios.",
          "error"
        );
        return true;
      }
      ...
      if (this.cliente_existe) {
        this.showAlert(
          "El nit o numero de documento ingresado ya se encuentra registrado en nuestra base de datos",
          "error"
        );
        return true;
      }
      if (this.razon_social == "") {
        this.showAlert(
          "Error, debe diligenciar el Nombre completo / Razón social.",
          "error"
        );
        return true;
      }
      if (this.fecha_constitucion == "") {
        this.showAlert(
          "Error, debe diligenciar la fecha de constitución.",
          "error"
        );
        return true;
      }
      if (this.empleados_empresa == "") {
        this.showAlert(
          "Error, debe diligenciar Cuantos empleados conforman la empresa.",
          "error"
        );
        return true;
      }
      ...
      if (this.estrato == "") {
        this.showAlert(
          "Error, debe diligenciar el Estrato socio económico (ubicación empresa).",
          "error"
        );
        return true;
      }
      if (this.municipio == "" || this.municipio == undefined) {
        this.showAlert(
          "Error, debe diligenciar el campo ciudad en informacion general.",
          "error"
        );
        return true;
      }
      if (this.direccion_empresa == "") {
        this.showAlert(
          "Error, debe diligenciar la dirección de la empresa en información general.",
          "error"
        );
        return true;
      }
      if (this.contacto_empresa == "") {
        this.showAlert(
          "Error, debe diligenciar la persona contacto empresa en información general.",
          "error"
        );
        return true;
      }
      if (this.correo_electronico_empresa == "") {
        this.showAlert(
          "Error, debe diligenciar el correo electrónico en información general.",
          "error"
        );
        return true;
      }
      if (this.telefono_empresa == "") {
        this.showAlert(
          "Error, debe diligenciar el teléfono empresa en información general.",
          "error"
        );
        return true;
      }
      if (this.celular_empresa == "") {
        this.showAlert(
          "Error, debe diligenciar el número celular en información general.",
          "error"
        );
        return true;
      }
      if (this.sociedad_comercial == "") {
        this.showAlert(
          "Error, debe diligenciar la actividad económica: sociedad comercial.",
          "error"
        );
        return true;
      }
      if (this.periodicidad_liquidacion_id == "") {
        this.showAlert(
          "Error, debe diligenciar la periodicidad de pago.",
          "error"
        );
        return true;
      }
      if (this.plazo_pago == "") {
        this.showAlert(
          "Error, debe diligenciar el plazo pago (días).",
          "error"
        );
        return true;
      }
      if (
        this.municipio_prestacion_servicio == "" ||
        this.municipio_prestacion_servicio == undefined
      ) {
        this.showAlert(
          "Error, debe diligenciar el campo ciudad prestación servicio.",
          "error"
        );
        return true;
      }
      ...
      if (
        (this.ejecutivo_comercial == "" && this.tipo_cliente == 1) ||
        this.ejecutivo_comercial == undefined
      ) {
        this.showAlert(
          "Error, debe diligenciar el campo ejecutivo comercial.",
          "error"
        );
        return true;
      }
      if (
        ...
        this.showAlert(
          "Error, debe diligenciar el campo jornada laboral.",
          "error"
        );
        return true;
      }
      ...
      if (
        (this.rotacion_personal == "" && this.tipo_cliente == 1) ||
        this.rotacion_personal == undefined
      ) {
        this.showAlert(
          "Error, debe diligenciar el campo rotación de personal.",
          "error"
        );
        return true;
      }
      ...
      if (this.tipo_cliente != 2 && this.cargos[0].cargo == "") {
        if (
          this.cargos2[0].cargo_id == "" ||
          this.cargos2[0].riesgo_laboral_id == ""
        ) {
          this.showAlert(
            "Error, debe diligenciar los campos para cargos e ingresar minimo un cargo.",
            "error"
          );
          return true;
        }
        ...
        if (contador > 0) {
          self.showAlert(
            "Error, debe diligenciar los campos para cargos.",
            "error"
          );
          return true;
        }
      ...
      this.accionistas.forEach(function (item) {
        if (
          item.tipo_identificacion_id == "" ||
          item.tipo_identificacion_id == undefined
        ) {
          valida_campo++;
        }
        if (
      ...
      if (valida_campo > 0) {
        self.showAlert(
          "Error, debe diligenciar el tipo de identificacion para los accionistas",
          "error"
        );
        return true;
      }
      if (valida_campo_dependiente > 0) {
        self.showAlert(
          "Error, debe diligenciar los campos correspondientes para accionistas",
          "error"
        );
        return true;
      }
      ...
      this.representantes_legales.forEach(function (item) {
        if (
          item.tipo_identificacion == "" ||
          item.tipo_identificacion == undefined
        ) {
          valida_campo++;
        }
      ...
      if (valida_campo > 0) {
        self.showAlert(
          "Error, debe diligenciar los campos obligatorios para los representantes legales",
          "error"
        );
        return true;
      }
      if (valida_campo_dependiente > 0) {
        self.showAlert(
          "Error, debe diligenciar los campos correspondientes para los representantes legales",
          "error"
        );
        return true;
      }
      ...
      if (this.responsable_impuesto_ventas == "") {
        this.showAlert(
          "Error, debe diligenciar el campo responsable de impuesto a las ventas.",
          "error"
        );
        return true;
      }
      if (this.correo_factura_electronica == "") {
        this.showAlert(
          "Error, debe diligenciar el Correo para factura electrónica.",
          "error"
        );
        return true;
      }
      if (this.sucursal == "") {
        this.showAlert(
          "Error, debe seleccionar la sucursal de facturación.",
          "error"
        );
        return true;
      }
      ...
      if (
        this.calidad_tributaria[0].opcion == "" ||
        this.calidad_tributaria[0].opcion == undefined
      ) {
        this.showAlert(
          "Error, debe seleccionar el campo ¿es gran contribuyente?.",
          "error"
        );
        return true;
      }
      if (
        this.calidad_tributaria[0].opcion == 1 &&
        this.calidad_tributaria[0].numero_resolucion == "" &&
        this.calidad_tributaria[0].fecha == ""
      ) {
        this.showAlert(
          "Error, debe diligenciar el numero de resulucion y la fecha en calidad tributaria.",
          "error"
        );
        return true;
      }
      if (
        this.calidad_tributaria[1].opcion == "" ||
        this.calidad_tributaria[1].opcion == undefined
      ) {
        this.showAlert(
          "Error, debe seleccionar el campo ¿Es Auto-Retenedor?.",
          "error"
        );
        return true;
      }
      if (
        this.calidad_tributaria[1].opcion == 1 &&
        this.calidad_tributaria[1].numero_resolucion == "" &&
        this.calidad_tributaria[1].fecha == ""
      ) {
        this.showAlert(
          "Error, debe diligenciar el numero de resulucion y la fecha en calidad tributaria.",
          "error"
      ...
      if (
        this.calidad_tributaria[2].opcion == "" ||
        this.calidad_tributaria[2].opcion == undefined
      ) {
        this.showAlert(
          "Error, debe seleccionar el campo ¿Exento de Impuesto a la Renta?.",
          "error"
        );
        return true;
      }
      if (
        this.calidad_tributaria[2].opcion == 1 &&
        this.calidad_tributaria[2].numero_resolucion == "" &&
        this.calidad_tributaria[2].fecha == ""
      ) {
        this.showAlert(
          "Error, debe diligenciar el numero de resulucion y la fecha en calidad tributaria.",
          "error"
      ...
      if (
        this.tipo_identificacion_contador == "" ||
        this.tipo_identificacion_contador == undefined
      ) {
        this.showAlert(
          "Error, debe diligenciar el tipo de identificación en datos del contador.",
          "error"
        );
        return true;
      }
      if (
        this.tipo_identificacion_contador != 0 &&
        this.nombre_completo_contador == "" &&
        this.identificacion_contador == "" &&
        this.telefono_contador == ""
      ) {
        this.showAlert(
          "Error, debe diligenciar todos los campos en datos del contador.",
          "error"
        );
        return true;
      }
      ...
      if (this.costos_gastos == "") {
        this.showAlert(
          "Error, debe diligenciar los costos y gastos mensual.",
          "error"
        );
        return true;
      }
      ...
      if (this.reintegro_costos == "") {
        this.showAlert(
          "Error, debe diligenciar el reintegro de costos y gastos.",
          "error"
        );
        return true;
      }
      ...
      if (this.operaciones_modena_extranjera == "") {
        this.showAlert(
          "Error, debe diligenciar si realiza operaciones en moneda extranjera.",
          "error"
        );
        return true;
      }
      if (this.tipo_operacion_internacional == "") {
        this.showAlert(
          "Error, debe diligenciar el tipo de operacion internacional.",
          "error"
        );
        return true;
      }
      ...
      if (valida_campo > 0) {
        self.showAlert(
          "Error, debe diligenciar los campos obligatorios para las referencias bancarias",
          "error"
        );
        return true;
      }
      ...
      if (valida_campo > 0) {
        self.showAlert(
          "Error, debe diligenciar los campos obligatorios para personas expuestas",
          "error"
        );
        return true;
      }
      if (valida_campos_expuestas > 0) {
        self.showAlert(
          "Error, debe diligenciar los campos correspondientes para personas expuestas",
          "error"
        );
        return true;
      }
      if (this.tipo_origen_fondo == "") {
        this.showAlert(
          "Error, debe diligenciar el tipo de origen de los fondos.",
          "error"
        );
        return true;
      }
      if (this.tipo_origen_medios == "") {
        this.showAlert(
          "Error, debe diligenciar el tipo de origen de los medios .",
          "error"
        );
        return true;
      }
      if (this.otro_tipo_origen_medios == "") {
        this.showAlert(
          "Error, debe diligenciar el otro tipo de origen de los medios .",
          "error"
        );
        return true;
      }
      if (this.alto_manejo_efectivo == "") {
        this.showAlert(
          "Error, debe diligenciar si las operaciones que realiza por su actividad implican un alto manejo de efectivo .",
          "error"
        );
        return true;
      }
    ...
    save(registro_cambios = null) {
      ...
      try {
        ...
        if (id == undefined) {
          ...
          axios
            .post(
              self.URL_API + "api/v1/formulariocliente/" + id,
              this.registroCliente,
              config
            )
            .then(function (result) {
    ...
    crearCliente() {
      this.registroCliente = {
        ...
        contratacion_manipulacion_alimentos:
          this.consulta_contratacion_carnet_alimentos,
        ...
        contratacion_suministra_transporte:
          this.consulta_contratacion_transporte,
        contratacion_suministra_alimentacion:
          this.consulta_contratacion_alimentacion,
      ...
      this.registroCliente.referencias_comerciales =
        this.referencias_comerciales;
    ...
    convertFile(url) {
      ...
      return fetch(url)
        ...
        .then((blob) => {
          ...
          const archivo = new File([blob], nombre_archivo, {
    ...
    llenarFormularioGuardado(item = null) {
      ...
      this.consulta_departamento_prestacion_servicio =
        item.consulta_departamento_prestacion_servicio;
      this.consulta_municipio_prestacion_servicio =
      ...
      this.consulta_responsable_impuesto_ventas =
        item.consulta_responsable_impuesto_ventas;
      ...
      this.consulta_operacion_moneda_extranjera =
        item.consulta_operacion_moneda_extranjera;
      this.consulta_operacion_internacional =
        item.consulta_operacion_internacional;
      ...
      this.consulta_origen_manejo_efectivo =
        item.consulta_origen_manejo_efectivo;
      ...
      this.consulta_municipio = item.consulta_municipio;
      this.consulta_pais_prestacion_servicio =
        item.consulta_pais_prestacion_servicio;
      this.consulta_departamento_prestacion_servicio =
        item.consulta_departamento_prestacion_servicio;
      this.consulta_municipio_prestacion_servicio =
        item.consulta_municipio_prestacion_servicio;
      ...
      this.consulta_personal_vinculado_temporal =
        item.consulta_personal_vinculado_temporal;
      ...
      this.consulta_induccion_entrenamiento =
        item.consulta_induccion_entrenamiento;
      ...
      this.contratacion_correo_electronico =
        item.contratacion_correo_electronico;
      ...
      this.consulta_contratacion_carnet_alimentos =
        item.contratacion_manipulacion_alimentos;
      this.contratacion_confirma_ingreso = item.contratacion_confirma_ingreso;
      this.consulta_contratacion_talla_uniforme =
        item.contratacion_tallas_uniforme;
      this.consulta_contratacion_transporte =
        item.contratacion_suministra_transporte;
      this.consulta_contratacion_alimentacion =
        item.contratacion_suministra_alimentacion;
      this.consulta_contratacion_pago_efectivo =
        item.contratacion_pago_efectivo;
      ...
      if (item.cargos.length > 0) {
        ...
        this.cargos = [
          { cargo: "", requisitos: [], examenes: [], riesgo_laboral_id: "" },
        ];
      }
      ...
      this.consulta_calidad_tributaria[0] =
        item.calidad_tributaria[0].opcion == "1"
          ? "Si"
          : item.calidad_tributaria[0].opcion == "0"
          ? "No"
          : "";
      ...
      this.consulta_calidad_tributaria[1] =
        item.calidad_tributaria[0].opcion == "1"
          ? "Si"
          : item.calidad_tributaria[0].opcion == "0"
          ? "No"
      ...
      this.consulta_calidad_tributaria[2] =
        item.calidad_tributaria[0].opcion == "1"
          ? "Si"
          : item.calidad_tributaria[0].opcion == "0"
          ? "No"
    ...
    llenarFormulario(item = null) {
      try {
        ...
        this.contratacion_directa =
          item.contratacion_directa == 0
            ? false
            : item.contratacion_directa == null
            ? false
            : true;
        this.atraccion_seleccion =
          item.atraccion_seleccion == 0
            ? false
            : item.atraccion_seleccion == null
            ? false
            : true;
        this.nit = item.nit;
        this.fecha_constitucion = item.fecha_constitucion;
        ...
        this.consulta_actvidad_ciiu =
          item.codigo_actividad_ciiu + " " + item.actividad_ciiu_descripcion;
        ...
        this.consulta_responsable_impuesto_ventas =
          item.responsable_inpuesto_ventas == "1" ? "Si" : "No";
        this.responsable_impuesto_ventas = item.responsable_inpuesto_ventas;
        ...
        this.tipo_operacion_internacional =
          item.tipo_operacion_internacional_id;
        this.consulta_operacion_internacional =
          item.tipo_operacion_internacional;
        this.operaciones_modena_extranjera = item.operaciones_internacionales;
        this.consulta_operacion_moneda_extranjera =
          item.operaciones_internacionales == 1 ? "Si" : "No";
        if (item.origen_fondos != null) {
          ...
          this.otro_tipo_origen_medios =
            item.origen_fondos.tipo_origen_medios2_id;
          this.alto_manejo_efectivo = item.origen_fondos.alto_manejo_efectivo;
          this.consulta_origen_manejo_efectivo =
            item.origen_fondos.alto_manejo_efectivo == 1 ? "Si" : "No";
        }
        this.nombre_completo_contador = item.nombre_contador;
        this.identificacion_contador = item.identificacion_contador;
        this.telefono_contador = item.telefono_contador;
        this.tipo_identificacion_contador =
          item.tipo_identificacion_id_contador;
        ...
        this.consulta_personal_vinculado_temporal =
          item.vinculado_empresa_temporal;
        ...
        this.requiere_anexo_factura_id =
          item.requiere_anexo_factura == "Si" ? 1 : 0;
        ...
        this.induccion_entrenamiento_id =
          item.induccion_entrenamiento == "Si" ? 1 : 0;
        ...
        this.vinculado_empresa_temporal_id =
          item.vinculado_empresa_temporal == "Si" ? 1 : 0;
        this.contratacion_contacto = item.contratacion_contacto;
        this.contratacion_cargo = item.contratacion_cargo;
        this.contratacion_telefono = item.contratacion_telefono;
        this.contratacion_celular = item.contratacion_celular;
        ...
        this.consulta_contratacion_carnet_alimentos =
          item.contratacion_manipulacion_alimentos;
        this.contratacion_confirma_ingreso =
          item.contratacion_hora_confirmacion;
        this.consulta_contratacion_talla_uniforme =
          item.contratacion_tallas_uniforme;
        this.consulta_contratacion_transporte =
          item.contratacion_suministra_transporte;
        ...
        this.consulta_contratacion_pago_efectivo =
          item.contratacion_pago_efectivo;
        this.consulta_contratacion_carnet =
          item.contratacion_carnet_corporativo;
        this.consulta_contratacion_pago_31 = item.contratacion_pagos_31;
        ...
        if (item["ubicacion_laboratorio"][0] != undefined) {
          this.consulta_pais_laboratorio =
            item["ubicacion_laboratorio"][0].pais;
          this.consulta_departamento_laboratorio =
            item["ubicacion_laboratorio"][0].departamento;
          this.consulta_municipio_laboratorio =
            item["ubicacion_laboratorio"][0].municipio;
          this.pais_laboratorio_id = item["ubicacion_laboratorio"][0].pais_id;
          this.departamento_laboratorio_id =
            item["ubicacion_laboratorio"][0].departamento_id;
          this.municipio_laboratorio_id =
            item["ubicacion_laboratorio"][0].municipio_id;
        }
        ...
        if (item.cargos2.length > 0) {
          ...
          for (let i = 0; i < item.cargos2.length; i++) {
            ...
            this.array_lista_examenes[i] = item.cargos2[i].examenes;
            this.array_lista_recomendaciones[i] =
              item.cargos2[i].recomendaciones;
          }
        } else {
          this.cargos2 = [
            {
        ...
        item.referencia_bancaria.forEach(function (item, index) {
          ...
          self.referencias_bancarias[index].tipo_cuenta =
            item.tipo_cuenta_banco;
        });
        ...
        if (item.calidad_tributaria[0] != undefined) {
          this.consulta_calidad_tributaria[0] =
            item.calidad_tributaria[0].gran_contribuyente == "1"
              ? "Si"
              : item.calidad_tributaria[0].gran_contribuyente == "0"
              ? "No"
              : "";
          this.calidad_tributaria[0].opcion =
            item.calidad_tributaria[0].gran_contribuyente;
          this.calidad_tributaria[0].numero_resolucion =
            item.calidad_tributaria[0].resolucion_gran_contribuyente;
          this.calidad_tributaria[0].fecha =
            item.calidad_tributaria[0].fecha_gran_contribuyente;

          this.consulta_calidad_tributaria[1] =
            item.calidad_tributaria[0].auto_retenedor == "1"
              ? "Si"
              : item.calidad_tributaria[0].auto_retenedor == "0"
              ? "No"
              : "";
          this.calidad_tributaria[1].opcion =
            item.calidad_tributaria[0].auto_retenedor;
          this.calidad_tributaria[1].numero_resolucion =
            item.calidad_tributaria[0].resolucion_auto_retenedor;
          this.calidad_tributaria[1].fecha =
            item.calidad_tributaria[0].fecha_auto_retenedor;

          this.consulta_calidad_tributaria[2] =
            item.calidad_tributaria[0].exento_impuesto_rent == "1"
              ? "Si"
              : item.calidad_tributaria[0].exento_impuesto_rent == "0"
              ? "No"
              : "";
          this.calidad_tributaria[2].opcion =
            item.calidad_tributaria[0].exento_impuesto_rent;
          this.calidad_tributaria[2].numero_resolucion =
            item.calidad_tributaria[0].resolucion_exento_impuesto_rent;
          this.calidad_tributaria[2].fecha =
            item.calidad_tributaria[0].fecha_exento_impuesto_rent;
        }
