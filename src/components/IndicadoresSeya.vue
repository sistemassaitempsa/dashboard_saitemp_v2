<template>
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col">
        <span v-if="char2"
          >Cantidad de radicados por tipo de servicio por cada mes del
          año.</span
        >
        <GraficoBarras
          @graficoCargado="graficoCargado"
    ...
    <div class="row">
      <div :class="!expandido ? 'col-6' : 'col-12'">
        <span v-if="char3"
          >Cantidad de contrataciones efectivas por cada mes del año.</span
        >
        <GraficoBarras
          @graficoCargado="graficoCargado"
          :labels_x="labels_x"
          :items="vacantes_ocupadas"
          :datosS="cantidad_vacantes"
          :index="3"
        />
      </div>
      <div :class="!expandido ? 'col-6' : 'col-12'">
        <span v-if="char3"
          >Cantidad de ingreso de empleados por cada mes del año.
          (Estimado)</span
        >
        <GraficoBarras
          @graficoCargado="graficoCargado"
          :labels_x="labels_x"
          :items="ingresos_empleados"
          :datosS="cantidad_ingresos_empleados"
          :index="3"
        />
      </div>
    </div>
    <div class="row">
      <div class="col-12">
        <span v-if="char3"
          >Cantidad de registros por estado y responsable.</span
        >
        <GraficoBarrasApiladas
          @graficoCargado="graficoCargado"
          :labels_x="responsable_estado"
          :datosS="registros_estado"
          :index="3"
        />
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    getCantidadVacantesesTipoServicio(anio = null) {
      ...
      axios
        .get(
          self.URL_API + "api/v1/cantidadvacantestiposervicio/" + anio,
          config
        )
        .then(function (result) {
          result.data.forEach(function (item, index) {
