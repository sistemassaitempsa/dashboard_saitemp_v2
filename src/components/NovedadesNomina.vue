<template>
  <div class="container">
    ...
    <form @submit.prevent="save()">
        ...
        <div class="row">
          ...
          <div class="col mb-3">
            ...
            <input
              ...
              id="exampleInputEmail1"
              aria-describedby="emailHelp"
              v-model="numero_convenio"
              @input="
                (numero_convenio = validarNumero(numero_convenio)),
                  calcularDigitoVerificacion(numero_convenio)
              "
            />
            <span
              id="validate"
              v-if="numero_convenio == '' && submitted"
              class="error"
              >{{ mensaje_error }}</span
            >
          </div>
        ...
        >
          ...
          <div class="col">
            ...
            <span
              ...
              class="error"
              >¡Por favor adjunte el archivo!</span
            >
          </div>
          <div class="col">
      ...
      <button class="btn btn-success" type="submit" style="margin: 30px">
        Guardar
      </button>
    </form>
  </div>
      ...
      this.fileInputsCount = [
        {
          id: 1,
          nombre:
            "Cámara de comercio (Archivo PDF, expedición menor 30 días): ",
          abreviacion: "",
          tipo_archivo: ".pdf",
          tipo_proveedor_id: "1",
          created_at: null,
