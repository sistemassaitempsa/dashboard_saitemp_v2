  ...
  <div class="container">
          ...
          <div class="row">
            <div class="col-sm-12 col-md-6 mb-3">
              ...
              <input
                ...
                id="exampleInput2"
                @input="
                  nombre_solicitante = formatInputUpperCase($event.target.value)
                "
                aria-describedby="emailHelp"
          ...
          <div class="row">
            <div class="col-sm-12 col-md-6 mb-3">
              ...
              <input
                ...
                id="exampleInput2"
                @input="
                  correo_solicitante = formatInputUpperCase($event.target.value)
                "
                aria-describedby="emailHelp"
          ...
          <div v-for="(item, index) in cargos" :key="index">
            <div class="row">
              <div class="col-sm-12 col-md-6 mb-3">
                ...
                <input
                  ...
                  id="exampleInput2"
                  @input="
                    item.nombre = formatInputUpperCase($event.target.value)
                  "
                  aria-describedby="emailHelp"
                  v-model="item.nombre"
                  required
              ...
              <div class="col-sm-12 col-md-6">
                <SearchList
                  nombreCampo="Cantidad de personas para el cargo: *"
                  nombreItem="nombre"
                  eventoCampo="getPersonasCargo"
                  :consulta="cantidad_personas[index]"
                  :index="index"
                  :registros="personas_cargo"
                  @getPersonasCargo="getPersonasCargo"
                  placeholder="Seleccione una opción"
                />
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12 col-md-6 mb-3">
                ...
                <input
                  ...
                  autocomplete="off"
                  id="exampleInput2"
                  @input="item.salario = validarNumero(item.salario)"
                  aria-describedby="emailHelp"
            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-md-6 mb-3">
                ...
                <textarea
                  ...
                  @input="
                    item.observaciones = formatInputUpperCase(
                      $event.target.value
                    )
                  "
                ></textarea>
            ...
            <div class="row">
              <div class="col-sm-12 col-md-6">
                <SearchList
                  ...
                  :consulta="consulta_departamento[index]"
              ...
              <div class="col-sm-12 col-md-6">
                <SearchList
                  ...
                  :consulta="consulta_municipio[index]"
            ...
            <div class="row">
              <div class="col-sm-12 col-md-6" v-if="item.oculta_estado_cargo">
                <SearchList
                  nombreCampo="Estado del cargo: *"
                  nombreItem="nombre"
                  eventoCampo="getEstadoCargo"
                  :consulta="consulta_estado_cargo[index]"
                  :index="index"
                  :registros="estados_cargos"
                  @getEstadoCargo="getEstadoCargo"
                  placeholder="Seleccione una opción"
                />
              </div>
              <div
                class="col-sm-12 col-md-6 mb-3"
                v-if="cargos[index].estado_cargo_id == 4"
              >
                ...
                <textarea
                  ...
                  @input="
                    item.motivo_cancelacion = formatInputUpperCase(
                      $event.target.value
                    )
                  "
                ></textarea>
              ...
              <div
                class="col-sm-12 col-md-6 mb-3"
                v-if="cargos[index].estado_cargo_id == 3"
              >
                ...
                <input
                  ...
                  autocomplete="off"
                  @input="
                    item.vacantes_ocupadas = validarNumero(
                      item.vacantes_ocupadas
                    )
                  "
                  aria-describedby="emailHelp"
                  placeholder=""
                  id="exampleInput2"
                  v-model="item.vacantes_ocupadas"
                  required
                />
                <div class="invalid-feedback">
                  {{ mensaje_error }}
    ...
    <div class="card col-xs-12 col-md-6">
      <form
        class="was-validated"
        ref="cliente"
        @submit.prevent="enviarHojasVida()"
      >
        <div id="seccion">
          ...
          <div class="row" v-for="(item, index) in cargos" :key="index">
            ...
            <div class="row">
              <div
                class="col botones"
                v-for="(item2, index2) in hojas_vida[index].hojas_vida"
                :key="index2"
              >
                <div class="btn-group" role="group" aria-label="Basic example">
                  <button type="button" class="btn adjunto">
                    <i class="bi bi-file-earmark-check"></i> {{ item2.name }}
                    {{ formatearPesoArchivo(item2.size) }}
                  </button>
                  <button
                    type="button"
                    @click="hojas_vida[index].hojas_vida.splice(index2, 1)"
              ...
              <tbody>
                <tr v-for="(item, index) in hojas_vida_enviadas" :key="index">
                  ...
                  <td>
                    <div
                      class="row"
                      v-for="(item, index) in item.detalles"
                      :key="index"
                    >
                  ...
                  <td>
                    <div
                      class="row"
                      v-for="(item2, index) in item.detalles"
                      :key="index"
                    >
                      <div class="col-12 m-1">
                        <button type="button" class="btn btn-success btn-sm">
                          <a
                            :href="URL_API + item2.ruta_documento"
                            target="_blank"
                            style="color: white; text-decoration: none"
                            rel="noopener noreferrer"
                            ><i class="bi bi-eye"> ver hoja de vida</i></a
                          >
                        </button>
                      </div>
                    </div>
...
export default {
  ...
  methods: {
    ...
    getCliente() {
      ...
      axios
        .get(
          self.URL_API + "api/v1/ordenserviciocliente/" + self.id_cliente,
          config
        )
    ...
    llenarCamposClinte(cliente) {
      ...
      cliente.cargos.forEach(function (item, index) {
        ...
        self.cargos[index].fecha_solicitud = self.reformatearFecha(
    ...
    guardarCliente() {
      ...
      if (id != undefined) {
        axios
          .put(
            self.URL_API + "api/v1/ordenserviciocliente/" + id,
            cliente,
            config
          )
          .then(function (result) {
