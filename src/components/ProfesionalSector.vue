    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xs-12 col-md-3">
          <SearchList
            ...
            :valida_campo="false"
            nombreItem="nombres"
            eventoCampo="getProfesionalLista"
            :consulta="consulta_codigo_ciiu"
            :registros="profesionalesLista"
            @getProfesionalLista="getProfesionalLista"
        ...
        <div class="col-xs-12 col-md-3">
          <SearchList
            nombreCampo="Sector economico*"
            :valida_campo="false"
            nombreItem="nombre"
            eventoCampo="getSectoresEconomicos"
            :consulta="consulta_sector_economico"
            :registros="sectores_economicos"
            @getSectoresEconomicos="getSectoresEconomicos"
            placeholder="Seleccione una opción"
          />
        </div>
        <button
        ...
        <div class="mb-3" v-if="asignar_sectores.length > 0">
          ...
          >
            <button
              ...
              class="btn btn-sm"
              data-bs-toggle="button"
              v-for="(item, index) in asignar_sectores"
              :key="index"
            >
              {{ item.nombre }}
      ...
      <div class="row">
        ...
        <button
          ...
          style="margin-top: 33px"
          @click="getProfesionalSectorTabla()"
        >
...
function getSectoresEconomicos(item = null) {
  ...
  axios
    .get(URL_API.value + "api/v1/sectoreconomicolista", configHeader())
    .then(function (result) {
      sectores_economicos.value = result.data;
    });
}

function getProfesionalLista(item = null) {
  ...
  axios
    ...
    .then(function (result) {
      profesionalesLista.value = result.data;
    });
}

function getProfesionalsector() {
  axios
    .get(URL_API.value + "api/v1/sectorEconomicoProfesional", configHeader())
    .then(function (result) {
...
function asignar() {
  ...
  axios
    .post(
      URL_API.value + "api/v1/profesionalsector",
      sector_profesional,
      configHeader()
    )
    .then(function (result) {
