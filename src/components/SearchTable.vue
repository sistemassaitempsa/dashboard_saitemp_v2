    ...
    <div class="mb-3">
      ...
      <div class="input-group">
        ...
        <span
          ...
          @click="(registro = ''), retornoValorCampo()"
          id="basic-addon3"
          ><i class="bi bi-x"></i
        ></span>
                    ...
                    <td
                      ...
                      @click="
                        (registro = item[campos2[0]] + ' ' + item[campos2[1]]),
                          retornoValorCampo(item[campos2[0]]),
                          (modal = !modal)
                      "
                    >
                      {{ item[item2] }}
...
export default {
  ...
  props: {
    ...
    showmodal: {
      ...
      required: false, // No es obligatorio
      default: false, // Valor predeterminado: falso
    },
    nombreItem: {
    ...
    valida_campo: {
      type: Boolean, // Define que debe ser un booleano
      required: false, // No es obligatorio
      default: true, // Valor predeterminado: verdadero
    },
    eventoCampo: {
      type: String, // Define que debe ser una función
      required: false, // No es obligatorio
      default: "", // Valor predeterminado: nulo
    },
    ubicacion: {
