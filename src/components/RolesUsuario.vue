  ...
  <div>
    <div class="container">
      ...
      <div class="card col-xs-12 col-md-6">
        ...
        <form>
          ...
          <button
            ...
            v-if="permisos[11].autorizado || permisos[12].autorizado"
            @click="save()"
          >
      ...
      <Tabla
        ...
        :campos="campos"
        :editar="permisos[12].autorizado"
        :eliminar="permisos[13].autorizado"
        @response="response"
        @clear="clear"
        @check="check"
      />
...
export default {
  ...
  methods: {
    ...
    getItems() {
      let self = this;
      let urlEndPoint = "";
      urlEndPoint = self.URL_API + "api/v1/roles/" + self.cantidad;
      if (this.currentUrl != "") {
    ...
    save() {
      if (this.checks.length > 0) {
        ...
        if (self.actualizar) {
          urlEndPoint = self.URL_API + "api/v1/roles/" + self.idItem;
        } else {
          urlEndPoint = self.URL_API + "api/v1/roles";
        }
        let config = this.configHeader();
        axios.post(urlEndPoint, self.rol, config).then(function (result) {
