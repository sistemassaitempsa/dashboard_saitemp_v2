<template>
  <div>
    <div class="container">
      ...
      <div class="card col-xs-12 col-md-12">
        ...
        <form class="was-validated" @submit.prevent="saveCategoria()">
          ...
          <div class="row">
            <div class="col">
              <div class="mb-3">
                ...
                <input
                  ...
                  aria-describedby="emailHelp"
                  @input="
                    categoria_menu.posicion = validarNumero(
                      categoria_menu.posicion
                    )
                  "
            ...
            <div class="col">
              <label for="exampleInputEmail1" class="form-label"
                >¿Este menú debe estár oculto?</label
              >
              <select
                class="form-select"
                v-model="categoria_menu.oculto"
      ...
      <Tabla
        :datos="categorias_menu"
        :tabla="tabla_catageria_menu"
        :endpoint="endpoint1"
        :editar="permisos[5].autorizado"
        :eliminar="permisos[6].autorizado"
        :messageDelete="messageDelete"
        :massiveUpdate="massiveUpdate1"
        :campos="campos"
        @getItems="getItems"
        @response="response1"
        @clear="clear1"
      ...
      <div class="card col-xs-12 col-md-12">
        ...
        <form class="was-validated" @submit.prevent="saveMenu()">
          ...
          <div class="row">
            ...
            <div class="col">
              <label for="exampleInputEmail1" class="form-label"
                >¿La url dirige a una página externa?</label
              >
              <select
                class="form-select"
                v-model="menu.url_externa"
                aria-label="Default select example"
              >
                <!-- <option selected>Seleccione una opción</option> -->
                <option value="0">No</option>
            ...
            <div class="col">
              <div class="mb-3">
                ...
                <input
                  ...
                  id="exampleInputEmail1"
                  aria-describedby="emailHelp"
                  @input="menu.posicion = validarNumero(menu.posicion)"
                  v-model="menu.posicion"
                />
              </div>
            </div>
            <div class="col">
          ...
          <div class="row">
            <div class="col">
              <SearchList
                nombreCampo="Menú principal:"
                @getCategoriasMenuLista="getCategoriasMenuLista"
                eventoCampo="getCategoriasMenuLista"
                :ordenCampo="1"
                nombreItem="nombre"
                required="true"
                :registros="categorias_menu_lista"
                :consulta="consulta_categoria_menu"
      ...
      <Tabla
        ...
        :tabla="tabla_menu"
        :endpoint="endpoint2"
        :massiveUpdate="massiveUpdate2"
        :campos="campos"
        :editar="permisos[8].autorizado"
        :eliminar="permisos[9].autorizado"
        @response="response2"
        @clear="clear2"
        @check="check"
      />
  ...
  methods: {
    ...
    validaCamposCategoriasMenu() {
      ...
      if (this.categoria_menu.posicion == undefined) {
        this.categoria_menu.posicion =
          parseInt(this.categorias_menu.data.data[0].posicion) + 1;
      }
    },
    validaCamposMenu() {
