            ...
            <div class="col">
              <div class="mb-3">
                ...
                <input
                  ...
                  v-model="nombres"
                  :disabled="diligenciado || checks.length > 1"
                />
              </div>
            </div>
            <div class="col">
            ...
            <div class="col">
              <div class="col-xs-12 col-md-12">
                <div>
                  ...
                  <select
                    class="form-select"
                    v-model="tipo_documento_identidad"
                    :disabled="diligenciado"
                    @change="tipoDocumentoId(tipo_documento_identidad)"
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-md-6">
              <div v-if="userlogued.rol == 'S. Administrador'">
                ...
                <select
                  class="form-select"
                  v-model="estado_empleado"
                  :disabled="diligenciado"
                  @change="estadoId(estado_empleado)"
                  aria-label="Default select example"
                >
              ...
              <div class="input-group mb-3">
                ...
                <span class="input-group-text" id="basic-addon1"
                  ><i
                    ...
                    style="cursor: pointer"
                    @click="(firma_file = ''), (firmaEmpleado = '')"
                  ></i
                ></span>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    getCargos() {
      ...
      let self = this;
      axios
        .get(self.URL_API + "api/v1/cargoslista", config)
        .then(function (result) {
    ...
    save() {
      if (this.checks.length > 0) {
        ...
        this.campos.tipo_documento_identidad_id =
        ...
        let config = this.configHeader();
        axios.post(urlEndPoint, form, config).then(function (result) {
