  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col">
        ...
        />
        <span v-if="char1"
          >Cantidad de cargos solicitados por cada mes del año.</span
        >
      </div>
      <div class="col">
        <GraficoBarras
          ...
          :labels_x="labels_x"
          :items="estados_cargo"
          :datosS="cantidad_vacantes_estado"
          :index="2"
        />
        <span v-if="char2"
          >Cantidad de estados para todos los cargos registrados por cada mes
          del año.</span
        >
      </div>
    </div>
    <div class="row">
      <div :class="!expandido ? 'col-6' : 'col-12'">
        <GraficoBarras
          ...
          :labels_x="labels_x"
          :items="label1"
          :datosA="cantidad_vacantes"
          :index="3"
        />
        <span v-if="char3"
          >Cantidad de vacantes en todos los cargos registrados por cada mes del
          año.</span
        >
      </div>
      <div class="col">
        ...
        />
        <span v-if="char4"
          >Cantidad de hojas de vida enviadas en todos los cargos registrados
          por cada mes del año.</span
        >
      </div>
    </div>
    <div class="row">
      <div class="col">
        <GraficoBarras
          ...
          :labels_x="labels_x"
          :items="items"
          :datosS="vacantes_cargos_hojasVida"
          :index="5"
        />
        <span v-if="char5"
          >Comparativa por cantidad entre cargos registrados, vacantes dispibles
          y hojas de vida enviadas por cada mes de año.</span
        >
      </div>
      <div class="col">
        <GraficoBarras
          ...
          :labels_x="labels_x"
          :items="items2"
          :datosA="vacantes_efectivas"
          :index="6"
        />
        <span v-if="char6"
          >Cantidad de vacantes ocupadas por cada mes de año.</span
        >
      </div>
    </div>
    <div class="row">
      <div class="col-6">
        ...
        />
        <span v-if="char7"
          >Nombre de los cargos registrados con la cantidad de vacantes
          solicitadas.</span
        >
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    getHojasVidaMes() {
      ...
      axios
        .get(
          self.URL_API + "api/v1/ordenserviciohojavidachar/" + "2023",
          config
        )
        .then(function (result) {
          Object.values(result.data).forEach(function (item) {
    ...
    getCantidadVacantesMes() {
      ...
      axios
        .get(
          self.URL_API + "api/v1/ordenserviciocargocantidadchar/" + "2023",
          config
        )
        .then(function (result) {
          Object.values(result.data).forEach(function (item) {
    ...
    getCargos() {
      ...
      axios
        .get(
          self.URL_API + "api/v1/ordenserviciocargocantidadchar2/" + "2023",
          config
        )
        .then(function (result) {
