<template>
  <div class="container">
        ...
        <div id="seccion">
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6 mb-3">
              <SearchList
                ...
                :consulta="consulta_tipo_identificacion_solicitante"
                placeholder="Seleccione una opción"
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
              <SearchList
                nombreCampo="Número de vacantes disponibles: *"
                nombreItem="nombre"
                eventoCampo="getVacantes"
                :consulta="consulta_vacantes"
                :registros="numero_vacantes"
                :ordenCampo="1"
          ...
          <div class="row">
            <div class="col-sm-12 col-md-6 mb-3">
              ...
              <textarea
                ...
                @input="
                  razon_social = formatInputUpperCase($event.target.value)
                "
              ></textarea>
              <div class="invalid-feedback">
                {{ mensaje_error }}
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6 mb-3">
              ...
              <input
                ...
                id="exampleInput2"
                @input="
                  celular_solicitante = validarNumero(celular_solicitante)
                "
                aria-describedby="emailHelp"
                v-model="celular_solicitante"
                required
              />
              <div class="invalid-feedback">
                {{ mensaje_error }}
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
              <SearchList
                nombreCampo="Servicio solicitado: *"
                nombreItem="nombre"
                eventoCampo="getServicios"
                :consulta="consulta_servicio_solicitado"
                :registros="servicios"
                :ordenCampo="1"
          ...
          <div class="row">
            <div class="col-sm-12 col-md-6">
              <SearchList
                ...
                :consulta="consulta_departamento_p_s"
            ...
            <div class="col-sm-12 col-md-6">
              <SearchList
                ...
                :consulta="consulta_municipio_p_s"
    ...
    <div class="card col-xs-12 col-md-6" style="overflow: hidden">
      ...
      >
        <div id="seccion">
          <h5 class="tituloseccion" v-if="this.servicio_solicitado_id == 1">
            Información personal candidato
          </h5>
          <hr v-if="this.servicio_solicitado_id == 1" />
          <div
            class="row"
            v-if="
              this.servicio_solicitado_id != 2 &&
              this.servicio_solicitado_id != 3 &&
              this.servicio_solicitado_id != 4
            "
          >
            <h5 style="text-align: left">
              Número de candidatos registrados: {{ candidatos.length }}
            </h5>
          </div>
          <div
            v-if="
              servicio_solicitado_id != 2 &&
              servicio_solicitado_id != 3 &&
              servicio_solicitado_id != 4
            "
            class="row"
          >
            <div class="col-sm-12 col-md-6 mb-3">
          ...
          >
            ...
            <div class="col-sm-12 col-md-4 mb-3">
              <SearchList
                ...
                nombreItem="nombre"
                eventoCampo="getDepartamentos"
                :consulta="consulta_departamento_n"
                :registros="departamentos"
                :ordenCampo="1"
                @getMunicipios="getMunicipios"
                placeholder="Seleccione una opción"
          ...
          >
            <div class="col-sm-12 col-md-6 mb-3">
              <SearchList
                ...
                @setTipoIdentificacion="setTipoIdentificacion"
                :registros="tiposIdentificacion"
                :consulta="consulta_tipo_identificacion_candidato"
                placeholder="Seleccione una opción"
              />
            </div>
            <div class="col-sm-12 col-md-6 mb-3">
              ...
              <input
                type="text"
                :class="{
                  'is-invalid': !documento_candidato,
                  'is-valid': documento_candidato,
                  'form-control': true,
                }"
                autocomplete="off"
                id="exampleInput2"
                @input="
                  documento_identidad_candidato = validarNumero(
                    documento_identidad_candidato
                  )
                "
                aria-describedby="emailHelp"
                v-model="documento_identidad_candidato"
                required
              />
              <div class="invalid-feedback">
                {{ mensaje_error }}
          ...
          <div id="seccion">
            ...
            <div class="row">
              <div class="col">
                <label class="form-check-label" for="flexSwitchCheckChecked"
                  >Por favor seleccione las bonificaciones:</label
                >
              </div>
              <div v-for="(item, index2) in bonificaciones" :key="index2">
                <div class="form-check check">
                  ...
                  <input
                    type="text"
                    v-model="item.valor"
                    placeholder="Valor de la bonificación"
            ...
            <div
              v-if="
                this.servicio_solicitado_id != '' &&
                this.servicio_solicitado_id != 1
              "
              class="row"
            >
              <label class="form-label"
                >Especificaciones a tener en cuenta para selección del
                personal:</label
              >
              <div class="col">
                <!-- <EditorTextoHtml
          ...
          <div class="row">
            <div class="col-sm-12 col-md-6 mb-3">
              <SearchList
                nombreCampo="Estado de la solicitud: "
                eventoCampo="getEstados"
                nombreItem="nombre"
                :registros="estados_solicitud"
                :consulta="consulta_estado_solicitud"
          ...
          <div class="row">
            <div class="col-sm-12 col-md-6 mb-3">
              <SearchList
                nombreCampo="Nombre laboratorio: *"
                eventoCampo="getLaboratorios"
                nombreItem="nombre"
                :registros="laboratorios"
                :consulta="consulta_laboratorio"
          ...
          <div class="row">
            <div class="col-sm-12 col-md-6">
              <SearchList
                nombreCampo="Departamento ubicación laboratorio: *"
                nombreItem="nombre"
                eventoCampo="getDepartamentos"
                :consulta="consulta_departamento_u_l"
                :registros="departamentos"
                :ordenCampo="2"
                @getMunicipios="getMunicipios"
                placeholder="Seleccione una opción"
            ...
            <div class="col-sm-12 col-md-6">
              <SearchList
                nombreCampo="Ciudad ubicación laboratorio: *"
                nombreItem="nombre"
                :registros="municipios"
                :consulta="consulta_municipio_u_l"
                @setMunicipios="setMunicipios"
                eventoCampo="setMunicipios"
                :ordenCampo="2"
                placeholder="Seleccione una opción"
          ...
          <div class="row">
            <div class="col-sm-12 col-md-6 mb-3">
              ...
              <textarea
                id=""
                style="width: 100%"
                v-model="recomendacion_examen_medico"
                required
              ></textarea>
              <div class="invalid-feedback">
                {{ mensaje_error }}
            ...
            <div class="col-sm-12 col-md-6 mb-3">
              <label class="form-label"
                >Orientación ubicación laboratorio:</label
              >
              <textarea
                id=""
                style="width: 100%"
                v-model="orientacion_laboratorio"
                required
              ></textarea>
              <div class="invalid-feedback">
                {{ mensaje_error }}
        ...
        <div
          class="col-sm-4 col-md-12 mt-2 mb-3"
          v-if="candidatos.length > 0 && servicio_solicitado_id == 1"
        >
          <nav
            ...
            <ul class="pagination">
              ...
              >
                <a
                  ...
                  "
                  class="page-link"
                  @click="llenarCampoCandidato(index), (pagina = index)"
                  >{{ index + 1 }}</a
                >
              </li>
            </ul>
        ...
        <div
          class="col-sm-4 col-md-12 mt-2 mb-3"
          v-else-if="cargos.length > 0 && servicio_solicitado_id != 1"
        >
          <nav
            aria-label="Page navigation example"
            style="padding: 0px; margin: 0px"
            ...
            <ul class="pagination">
              ...
              >
                <a
                  ...
                  "
                  class="page-link"
                  @click="llenarCampoCargo(index), (pagina = index)"
                  >{{ index + 1 }}</a
                >
              </li>
            </ul>
        ...
        <div
          class="row"
          v-if="
            $route.params.id == undefined && this.servicio_solicitado_id == 1
          "
        >
          ...
          <div class="col-sm-4 col-md-4 mt-2 mb-3">
            <button
              ...
              @click.prevent="eliminarCandidato()"
            >
        ...
        >
          ...
          <div class="col-sm-4 col-md-4 mt-2 mb-3" id="siguiente">
            <button
              class="btn btn-success"
              @click.prevent="agregarCargo(pagina)"
            >
          ...
          <div class="row" v-for="(item, index) in candidatos" :key="index">
            <div class="col-sm-12 col-md-6 mb-3">
              ...
              <input
                ...
                id="exampleInput2"
                aria-describedby="emailHelp"
                v-model="candidatos[index].documento_identidad_candidato"
              />
            </div>
            <div class="col-sm-12 col-md-6 mb-3">
...
export default {
  ...
  data() {
    return {
      ...
      vacante_id: "",
      mensaje_cliente:
        "Estimado cliente, Saitemp S.A se encuentra comprometido con la mejora en la calidad de los servicios ofrecidos; te invitamos a participar de la actualización del registro cliente de su negociación con el  propósito de cumplir con  las disposiciones legales exigidas por nuestros entes de control  ingresando  ( link debida diligencia) o comuníquese a la línea 3133024926 para recibir orientación en su proceso de actualización. ",
    };
  },
  computed: {
    nombres: function () {
    ...
    correo: function () {
      ...
      return (
        ...
        regexCorreoElectronico.test(this.correo_candidato)
      );
    },
  ...
  methods: {
    ...
    llenarCampoCliente() {
      if (localStorage.getItem("clienteos") != undefined) {
        ...
        this.consulta_departamento_p_s =
          cliente.departamento_prestacion_servicio;
        this.consulta_departamento_p_s_id =
          cliente.departamento_prestacion_servicio_id;
        this.consulta_municipio_p_s = cliente.ciudad_prestacion_servicio;
        this.ciudad_prestacion_servicio_id =
          cliente.ciudad_prestacion_servicio_id;
        this.consulta_tipo_identificacion_solicitante =
          cliente.consulta_tipo_identificacion_solicitante;
    ...
    llenarCampoCandidato(index = 0) {
      ...
      if (objeto != undefined && objeto.length > 0) {
        ...
        this.consulta_departamento_n =
          this.candidatos[index].departamento_nacimiento;
        this.consulta_departamento_n_id =
          this.candidatos[index].departamento_nacimiento_id;
        this.consulta_municipio_n = this.candidatos[index].municipio_nacimiento;
        this.consulta_municipio_n_id =
          this.candidatos[index].municipio_nacimiento_id;
        this.consulta_tipo_identificacion_candidato =
          this.candidatos[index].tipo_identificacion;
        this.tipo_identificacion_candidato =
          this.candidatos[index].tipo_identificacion_id;
        this.documento_identidad_candidato =
          this.candidatos[index].documento_identidad_candidato;
        ...
        this.consulta_textohtml_especificacion_v =
          this.candidatos[index].especificaciones_vinculacion;
        this.consulta_textohtml_especificacion_s =
          this.candidatos[index].especificaciones_seleccion;
        this.consulta_estado_solicitud =
          this.candidatos[index].estado_solicitud;
        ...
        this.direccion_laboratorio =
          this.candidatos[index].direccion_laboratorio;
        this.consulta_departamento_u_l =
          this.candidatos[index].departamento_laboratorio;
        this.departamento_u_l_id =
          this.candidatos[index].departamento_laboratorio_id;
        this.consulta_municipio_u_l =
          this.candidatos[index].municipio_laboratorio;
        ...
        this.recomendacion_examen_medico =
          this.candidatos[index].recomendaciones_examen_medico;
        this.orientacion_laboratorio =
          this.candidatos[index].orientacion_laboratorio;
        ...
        this.consulta_subcategoria_cargos[index] =
          this.candidatos[index].categoria;
        this.consulta_lista_cargos[index] = this.candidatos[index].cargo;
        this.consulta_textohtml_funciones =
          this.candidatos[index].consulta_textohtml_funciones;
        this.consulta_riesgo_laboral[index] =
          this.candidatos[index].riesgo_laboral[index];
        this.array_lista_examenes[index] = this.candidatos[index].examenes;
        this.array_lista_recomendaciones[index] =
          this.candidatos[index].recomendaciones;
      } else {
        this.getBonificaciones();
      }
    },
    llenarCampoCargo(index = 0) {
      ...
      if (objeto != undefined && objeto.length > 0) {
        ...
        this.consulta_textohtml_especificacion_v =
          this.cargos[index].especificaciones_vinculacion;
        this.consulta_textohtml_especificacion_s =
          this.cargos[index].especificaciones_seleccion;
        ...
        this.consulta_departamento_u_l =
          this.cargos[index].departamento_laboratorio;
        this.departamento_u_l_id =
          this.cargos[index].departamento_laboratorio_id;
        ...
        this.recomendacion_examen_medico =
          this.cargos[index].recomendaciones_examen_medico;
        this.orientacion_laboratorio =
          this.cargos[index].orientacion_laboratorio;
        ...
        this.consulta_textohtml_funciones =
          this.cargos[index].consulta_textohtml_funciones;
        this.consulta_riesgo_laboral[index] =
          this.cargos[index].riesgo_laboral[index];
        this.array_lista_examenes[index] = this.cargos[index].examenes;
        this.array_lista_recomendaciones[index] =
          this.cargos[index].recomendaciones;
      } else {
        this.getBonificaciones();
      }
    },
    ...
    siguiente(index = null) {
      if (this.$refs.candidato.checkValidity() && this.correo) {
        ...
        this.cargos2.forEach(function (item, index) {
          candidato.tipo_cargo =
            item.tipo_cargo == 1 ? "Administrativo" : "Operativo";
    ...
    validateNumericField(numero) {
      try {
        if (numero != "") {
          if (isNaN(numero)) {
            this.documento_identidad = numero.substr(0, numero.length - 1);
          }
        }
      } catch (error) {
        console.log(error);
