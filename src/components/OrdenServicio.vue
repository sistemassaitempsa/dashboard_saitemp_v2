  ...
  <div class="container">
    ...
    <div class="card p-3">
      <form class="was-validated" @submit.prevent="save()">
        <div class="row">
          <div class="col-6 mb-3" id="no-sede" tabindex="0" v-if="props.userlogued.tipo_usuario_id == 1">
            <SearchList nombreCampo="Cliente: *" nombreItem="razon_social" :registros="clientes"
              placeholder="Seleccione una opción" :consulta="consulta_cliente" @getClienteServicio="getClienteServicio"
              eventoCampo="getClienteServicio" @setClienteServicio="setClienteServicio"
              :valida_campo="$route.params.id == ''" />
          </div>
          <div class="col-6 mb-3" id="no-sede" tabindex="0" v-if="asignacion_manual">
            <SearchList nombreCampo="Responsable" nombreItem="nombres" :registros="lista_asignacion"
              placeholder="Seleccione una opción" :consulta="consulta_responsable" @setResponsable="setResponsable"
        ...
        <div class="row" v-if="params_id != ''">
          <div class="col">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="radicado" aria-describedby="emailHelp" v-model="radicado"
                disabled />
            </div>
          </div>
          <div class="col">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="radicador" aria-describedby="emailHelp" v-model="radicador"
                disabled />
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="razon_social" aria-describedby="emailHelp"
                v-model="razon_social" disabled />
              <div class="invalid-feedback">
                {{ mensaje_error }}
              </div>
            </div>
          ...
          <div class="col">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="ciiu" aria-describedby="ciiu" v-model="actividad_ciiu"
                disabled />
              <div class="invalid-feedback">
                {{ mensaje_error }}
              </div>
        ...
        <div class="row">
          <div class="col">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="sector_economico" aria-describedby="emailHelp"
                v-model="sector_economico" autocomplete="new-email" disabled />
              <div class="invalid-feedback">
                {{ mensaje_error }}
              </div>
            </div>
          ...
          <div class="col">
            <div class="mb-3">
              <label for="fecha_inicio" class="form-label">Fecha inicio solicitud: *</label>
              <input @keydown.prevent @click="abrirCalendario" type="date" class="form-control" id="fecha_inicio"
                aria-describedby="emailHelp" v-model="fecha_inicio" required :min="fecha_actual" :disabled="inhabilita_campo"
                @input="validaFecha()" />
              <div class="invalid-feedback">
                {{ mensaje_error }}
              </div>
          ...
          <div class="col">
            <div class="mb-3">
              <label for="fecha_fin" class="form-label">Fecha terminación solicitud: *</label>
              <input @keydown.prevent @click="abrirCalendario" type="date" class="form-control" id="fecha_fin"
                aria-describedby="emailHelp" v-model="fecha_fin" required :min="fecha_actual" @input="validaFecha()" :disabled="inhabilita_campo" />
              <div class="invalid-feedback">
                {{ mensaje_error }}
              </div>
            </div>
        ...
        <div class="row">
          <div class="col mb-3" id="no-sede" tabindex="0">
            <SearchList nombreCampo="Linea de servicio: *" @lineaServicio="lineaServicio" eventoCampo="lineaServicio"
              nombreItem="nombre" :registros="lineas_servicio" placeholder="Seleccione una opción" :disabled="inhabilita_campo"
          ...
          <div class="col">
            <SearchList nombreCampo="Departamento de prestación del servicio: *" nombreItem="nombre"
              ...
              :registros="departamentos" @getMunicipios="getMunicipios" placeholder="Seleccione una opción"  :disabled="inhabilita_campo"/>
          </div>
          <div class="col">
            <SearchList nombreCampo="Ciudad de prestación del servicio: *" nombreItem="nombre" :registros="municipios"
              :ordenCampo="1" :consulta="consulta_municipio_prestacion_servicio" @setMunicipios="setMunicipios" :disabled="inhabilita_campo"
              eventoCampo="setMunicipios" placeholder="Seleccione una opción" />
          </div>
        </div>
        <div class="row">
          <div class="col">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="nombre_contacto" aria-describedby="emailHelp"
                v-model="nombre_contacto" disabled />
              <div class="invalid-feedback">
                {{ mensaje_error }}
              </div>
            </div>
          ...
          <div class="col">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="telefono_contacto" aria-describedby="emailHelp"
                v-model="telefono_contacto" disabled @input="telefono_contacto = validarNumero(telefono_contacto)" />
              <div class="invalid-feedback">
                {{ mensaje_error }}
              </div>
            </div>
          ...
          <div class="col">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="cargo" aria-describedby="emailHelp" v-model="cargo_contacto"
                disabled />
              <div class="invalid-feedback">
                {{ mensaje_error }}
              </div>
        ...
        <div class="row">
          ...
          <div class="col">
            <div class="form-check" v-for="item in motivos_servicio" :key="item.id">
              <input class="form-check-input" type="radio" name="exampleRadios" :id="'exampleRadios' + item.id"
                :value="item.id" v-model="motivo_servicio_id" required :disabled="inhabilita_campo"/>
        ...
        <div class="row">
          <div class="col mt-3">
            <label for="cantidad_contrataciones: *" class="form-label">Cantidad contrataciones: *</label>
            <input type="text" class="form-control" id="cantidad_contrataciones" maxlength="2"
              aria-describedby="cantidad_contrataciones" v-model="cantidad_contrataciones" @input="
                cantidad_contrataciones = validarNumero(cantidad_contrataciones)
                " required :disabled="inhabilita_campo"/>
            <div class="invalid-feedback">
              {{ mensaje_error }}
            </div>
          </div>
          <div class="col">
            <SearchList nombreCampo="Cargo solicitado: *" nombreItem="nombre" :registros="cargos" :ordenCampo="1"
              :consulta="consulta_cargo_solicitado" @getCargos="getCargos" eventoCampo="getCargos"
              placeholder="Seleccione una opción" :disabled="inhabilita_campo"/>
          </div>
        </div>
        <div class="row">
          <div class="row">
        ...
        <div class="row">
          ...
          <div class="col">
            <div class="lista-multiple">
              <button style="margin: 5px" class="btn btn-success btn-sm" v-for="(item, index) in array_lista_examenes"
        ...
        <div class="row" v-for="(item, index3) in array_lista_recomendaciones" :key="index3">
          <div class="col orientacion">
            <label style="width: 100%">ORIENTACIONES ESPECIFICAS PARA LOS EXAMENES:</label>
            <span>{{ item.recomendacion1 }}</span>
          </div>
          <div class="col orientacion">
            <label style="width: 100%">PATOLOGIAS QUE RESTRINGEN LA LABOR:</label>
        ...
        <div class="row">
          <div class="col-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="salario" aria-describedby="emailHelp" v-model="salario"
                @input="salario = validarNumero(salario)" required :disabled="inhabilita_campo"/>
              <div class="invalid-feedback">
                {{ mensaje_error }}
              </div>
            </div>
        ...
        <div v-if="linea_servicio_id == 2">
          ...
          <div class="col">
            <div class="input-group">
              <input type="file" class="form-control" :id="'seleccionArchivos' + index" accept=".xls,.xlsx"
                @change="cargarArchivo($event, index)" aria-describedby="inputGroupFileAddon04" aria-label="Upload" :disabled="inhabilita_campo"/>
        ...
        <div v-if="linea_servicio_id == 2">
          ...
          <div v-for="(item, index) in candidatos" :key="item">
            <div class="row">
              ...
              <h6 style="float: left; width: auto;">Candidato {{ index + 1 }}</h6>
              <hr style="clear: both" />
              <div class="col-6">
                <SearchList nombreCampo="Tipo de Identificación: *" @getTipoIdentificacion="getTipoIdentificacion"
                  ...
                  nombreItem="des_tip" :ordenCampo="1" :index="index" :registros="tiposIdentificacion"
                  placeholder="Seleccione una opción" :consulta="candidatos[index].consulta_tipo_identificacion" :disabled="item.deshabilita_campo" />
              </div>
            </div>
            <div class="row">
              <div class="col">
                <div class="mt-3">
                  <label for="numero_documento_candidato" class="form-label">Número de documento: *</label>
                  <input type="text" class="form-control" id="numero_documento_candidato" aria-describedby="emailHelp"
                    v-model="item.numero_documento_candidato" @input="
                      item.numero_documento_candidato = validarNumero(
                        item.numero_documento_candidato
                      ), confirmaDocumento(item, index)
                      " required :disabled="item.deshabilita_campo"/>
                  <div class="invalid-feedback">
                    {{ mensaje_error }}
                  </div>
                </div>
              ...
              <div class="col">
                <div class="mt-3">
                  <label for="numero_documento_candidato" class="form-label">Confirma número de documento: *</label>
                  <input type="text" class="form-control" id="numero_documento_candidato" aria-describedby="emailHelp"
                    v-model="item.confirma_numero_documento_candidato" @input="
                      item.confirma_numero_documento_candidato = validarNumero(
                        item.confirma_numero_documento_candidato
                      ), confirmaDocumento(item, index)
                      " @focus=" confirmaDocumento(item, index)" required :disabled="item.deshabilita_campo_documento"
                    :class="error_documento_identidad[index] ? 'is-invalid' : 'input-success'" />
                  <div :class="{ 'invalid-feedback': error_documento_identidad[index] }">
                    {{ mensaje_error }}
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="nombre_candidato" aria-describedby="nombres"
                    v-model="item.nombre_candidato" required :disabled="item.deshabilita_campo"/>
                  <div class="invalid-feedback">
                    {{ mensaje_error }}
                  </div>
                </div>
              ...
              <div class="col">
                <div class="mb-3">
                  <label for="apellido_candidato" class="form-label">Apellidos: *</label>
                  <input type="text" class="form-control" id="apellido_candidato" aria-describedby="apellidos"
                    v-model="item.apellido_candidato" required :disabled="item.deshabilita_campo"/>
                  <div class="invalid-feedback">
                    {{ mensaje_error }}
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col">
                <div class="mb-3">
                  <label for="celular_candidato" class="form-label">Celular: *</label>
                  <input type="text" class="form-control" id="celular_candidato" aria-describedby="celular"
                    v-model="item.celular_candidato" @input="
              ...
              <div class="col">
                <div class="mb-3">
                  <label for="correo_candidato" class="form-label">Correo electrónico: *</label>
                  <input type="email" class="form-control" id="correo_candidato" aria-describedby="correo"
                    v-model="item.correo_candidato" required pattern="^[^\s@]+@[^\s@]+\..+$" :disabled="item.deshabilita_campo"/>
                  <div class="invalid-feedback">
            ...
            <div class="row float-end mb-3" v-if="candidatos.length > 0">
              <div class="col">
                <button type="button" class="btn btn-danger" @click="eliminarCandidato(index)">
        ...
        <div class="row float-start" v-if="linea_servicio_id == 2 && candidatos.length <= 98">
          <div class="col">
            <button type="button" class="btn btn-warning" @click="agregarCandidato">
              <i class="bi bi-person-plus"></i>
            </button>
          </div>
        </div>
        <div class="row">
          <div class="col" v-if="$route.params.id != '' && boton_crear_seiya && props.userlogued.tipo_usuario_id == 1">
            <button type="button" @click="crearRadicadoSeiya()" class="btn btn-success">Crear radicado seiya</button>
          </div>
          <div class="col">
...
const { showAlert, confirmAlert } = Alerts();
...
function validaFecha() {
  if (fecha_inicio.value != '' && fecha_fin.value != '') {
    ...
    if (fecha1.getTime() > fecha2.getTime()) {
      fecha_fin.value = ''
      confirmAlert('Fecha terminación solicitud inválida', 'La fecha terminación solicitud no puede ser menor a la fecha inicio solicitud', 'error')
    }
  }
}
...
function confirmaDocumento(item, index) {
  ...
  if (documento !== '' && confirma_documento !== '' && documento !== confirma_documento) {
    error_documento_identidad.value[index] = true;
    mensaje_error.value = '¡Este campo debe ser diligenciado!'
  } else if (documento === confirma_documento && item.tipo_identificacion_id != '' && documento !== '' && confirma_documento !== '') {
    const otrosCandidatos = candidatos.value.filter((_, i) => i !== index);
    if (otrosCandidatos.some(array => array.confirma_numero_documento_candidato === item.confirma_numero_documento_candidato)) {
      candidatos.value[index].confirma_numero_documento_candidato = '';
      confirmAlert('Candidato registrado',
        'La persona con número de documento ' + item.numero_documento_candidato + ' ya se encuentra en la lista de candidatos',
        'success'
      );
    } else {
      validaCandidato(item.numero_documento_candidato, index, item.tipo_identificacion_id,item);
...
function validaCandidato(documento, index, tipo_identificacion) {
  axios
    .get(URL_API.value + "api/v1/validacandidato/" + documento + '/' + index + '/' + tipo_identificacion, configHeader())
...
function candidatoValidado(data) {
  if (data.status == 'error') {
    let indice = candidatos.value.findIndex(candidato => candidato.confirma_numero_documento_candidato === data.documento);
...
function save() {
  ...
  error_documento_identidad.value.forEach((element, index) => {
    if (element == true) {
      showAlert('Por favor verifique los datos del candidato número ' + (index + 1), 'error')
      error_campo = true
    }
  });
  if (error_campo) {
  ...
  axios
    .post(url, crearObjeto(), configHeader())
    .then(function (result) {
...
function setClienteServicio(item) {
  axios
    .get(URL_API.value + "api/v1/clienteresponsableservicio/" + item.id, configHeader())
    .then(function (result) {
      nit.value = result.data.nit
      razon_social.value = result.data.razon_social
      actividad_ciiu.value = result.data.actividad_ciiu
...
function llenarFormulario(item) {
  ...
  consulta_municipio_prestacion_servicio.value = item.ciudad_prestacion_servicio
  ciudad_prestacion_servicio_id.value = item.ciudad_prestacion_servicio_id
  departamento_prestacion_servicio_id.value = item.departamento_prestacion_servicio_id
  consulta_departamento_prestacion_servicio.value = item.departamento_prestacion_servicio
